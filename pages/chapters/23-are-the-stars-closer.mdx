...
On the other hand, if the TYCHOS' 42633 factor for star distances is correct, we see that Proxima's true angular diameter (as seen in our telescopes) would amount to a more reasonable 42.633" arcseconds (42633 X 0.001 = 42.633) - which would make it only 45 times smaller than the Sun's undisputed 1920" angular diameter (1920" / 42.633" ≈ 45). Thus, if the TYCHOS' proposed Earth-Proxima distance of 6.3 AU is correct, this would indeed make Proxima about 7 times smaller than the Sun (45 / 6.3 ≈ 7.1) - in excellent accordance with official data! Let's now briefly see if the same calculus can be applied to Sirius, our largest star (as discussed in Chapter 6):

Officially, Sirius is reckoned to be 8.7 Light Years away. As we apply our 42633 reduction factor, the Earth-Sirius distance in the TYCHOS would be about **12.9AU** (8.7LY / 42633 = 12.9AU). The angular diameter of Sirius (as stated in the Wikipedia) is 0.005936″. As we multiply this value by 42633, we obtain 0.005936" X 42633 ≈ 253". Now, Sirius is estimated to be 1.7 times larger than the Sun, so let's first divide this value by 1.7 : 253 / 1.7 = 148.82" (which would be the expected angular diameter of Sirius - _IF it were the same size of the Sun_). As we finally divide the Sun's undisputed angular diameter (of 1920") by this value, we obtain: 1920 / 148.82 ≈ 12.9! In other words, it appears that our 42633 factor can even be used as a 'correction factor' for the currently-claimed (yet most implausibly small) telescopic angular diameters of our stars.   

At this point, you may be forgiven to suspect that some sort of foul play is being upheld in the realm of optical astronomy: if the TYCHOS 42633 factor (which I have determined independently from any optical considerations, solely by reducing the baseline of the Earth's semestral motion from 299.2 Mkm to 7018km) is COMMENSURATE to the apparent reduction that astronomers are applying to their telescopic angular measurements of the stars - **this can hardly be a matter of happenstance**. Someone, somewhere - must know. But let's get on.     
