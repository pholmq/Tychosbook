...
Let's now put our TYCHOS reduction factor to the test - and see how close our _closest_ star system (the Alpha Centauri binary pair) would be. Alpha Centauri is said to be 4.37 LY away. In the TYCHOS, Alpha Centauri would thus be located about 6.5AU away from Earth :

4.37LY X 1.4834 ≈ **6.48 AU**

This is rather interesting, for this TYCHOS-computed distance (6.48 AU) to Alpha Centauri would place our nearmost star at a distance roughly 'midway between' Jupiter (4.2 AU) and Saturn (8.5 AU). Note however that the Alpha Centauri binary system is _not_ located in the same plane as our solar system – but some 62° ‘below’ it. The two components of the Alpha Centauri binary system (Alpha A and Alpha B) are both currently believed to be about the same size of our Sun but, under the TYCHOS paradigm, they would of course be considerably smaller (yet _not necessarily_ 42633 X smaller).   
...
Well, if Vega is truly 37.144X more distant than the Sun (and appears to be 16X smaller), Vega would indeed be about 2.3X larger than the sun :
...
- If the stars are 42633 X closer than currently reckoned, their diameters may not necessarily be 42633 X smaller than currently believed. 

In any event, further study is needed in the field of optical astronomy, a branch of human knowledge rife with controversy still today. In fact, the long-debated question of the perceived star sizes and how they are affected by various phenomena (e.g. diffraction, "Airy disk", assorted optical issues, etc.) is far from being a settled matter. The same goes for the notion of redshift and blueshift being doppler effects currently used to determine whether stars are receding from or approaching our Solar System - but more about that in Chapter 26. 
...
However, we know that the Moon-Earth distance is constantly oscillating back and forth (i.e. cyclically approaching and receding). As we saw in Chapter 13, the Moon's orbit oscillates back and forth by 42108km (we shall call this value the "MMAO" - i.e. 'the Moon's Maximal Apsidal Oscillation'). So could the secular drift of the MMAO possibly be responsible for what astronomers interpret as an annual "4-cm recession of the Moon"? Let's see if this might be the case:

If we consider that the Earth-Moon system completes a full 360° revolution in 25344 years, we may envision how the MMAP (as its spatial orientation remains 'fixed' to the Moon's orbit) will slowly revolve ONCE _in relation to the Earth_ in 25344 years. We may thus calculate by how much the MMAO would appear to 'drift' annually (as viewed from the Earth and in relation to the stars):  

42108km / 25344y = 1.66km-per-year (representing the amount that the Moon will appear to 'recede' from us - yet being caused by the slow, secular 'precession' of the MMAO around Earth)

Now, astronomers are of course using the stars as background reference against which they gauge our Moon's motions (with instruments calibrated to the officially-estimated stellar distances). However, we just saw that the stars may be 42633 times closer than currently believed. So let's divide the above value by 42633 - and see what we obtain:  

1.66km / 42633 = 0.0000389km = **3.89cm** (i.e. the amount that astronomers reckon to be "the Moon's annual recession rate"!) 

In conclusion, the Moon is (thankfully) not parting from us anytime soon. What astromomers are "seeing" is just the very slow, 25344-year _secular precession_ of the MMAO - given by the tranquil 1-mph-revolution of the Earth-Moon system around the PVP orbit. We shall now see how some other well-known astronomical data (related to stellar motions) go to support my proposed “42633 reduction factor”.
...
Wow again! Or Good Heavens, actually! This is _exactly_ our EAM, i.e. Earth's Annual Motion as estimated in the TYCHOS model! 

In other words - and in conclusion - this _“general velocity perceived to exist between the stars and our Solar System”_ (ca. 19.4 km/s) would certainly seem to support both of the TYCHOS model’s "boldest" - yet most fundamental assertions:
