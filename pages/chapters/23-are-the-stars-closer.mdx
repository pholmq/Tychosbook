...
The Sun subtends about 0.53° (or 1920 arcseconds) in the sky, roughly the same as the Moon. Now, take a good look at the photograph in Fig. 23.4 and compare the sizes of the Moon and Sirius. Does Sirius appear to be several hundred thousand times smaller than the Moon?
...
**Fig. 23.5** If you hold an LP vinyl record at arm’s length towards the Sun, our star will fit into the record’s 7 mm hole. Tycho Brahe estimated the angular diameter of Vega to be about 16 times smaller than that of the Sun. Today’s astronomers, on the other hand, consider the ‘actual’ angular diameter of Vega to be 622000 times smaller!
