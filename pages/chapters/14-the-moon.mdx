...
**Fig. 14.6** The Moon is not accelerating, nor is Earth’s rotation decelerating. What causes
these illusory effects is simply explained by Earth’s slow motion (1 mph) around its PVP
orbit. The Moon maintains its constant orbital speed at all times.
...
**Fig. 14.9** This diagram illustrates why the Moon is observed to alternately accelerate and decelerate by a 0.8 coeffcient as it revolves around Earth, which itself travels at ∼1.6 km/h. The Moon travels at constant speed, the true value of which can only be gauged from Earth whenever it transits at either equinoxes (at equal distances).
