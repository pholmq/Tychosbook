...
Well, this is extremely interesting, because 1.58124km equals **0.0039457%** of 40075km (the circumference of planet Earth). As we saw in Chapter 12, Earth moves annually by 14036km (i.e. by **0.0039457%** of its PVP orbit circumference of 355 724 597km); this motion makes us 'meet up' with the Sun at a slightly earlier point of its own orbit (in fact, 37087km 'earlier' - which is **0.0039457%** of the solar orbit of 939 943 910km). Last but not least, 1 solar year equals **0.0039457%** of 25344 years (i.e. the exact duration of one Great Year - as computed in the TYCHOS model). 
