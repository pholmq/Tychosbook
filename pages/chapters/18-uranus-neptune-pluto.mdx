...
It is essential to understand what is meant by “the exact same place”. Yes, this means that these planets return to the same celestial location within the said time intervals. As viewed from Earth, however, they will _appear_ to have advanced by a small amount in relation to the starry background.
