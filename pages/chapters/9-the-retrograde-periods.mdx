...
**As an (important) aside, please know that our own Moon's axis of rotation is ALSO inclined by about 7° degrees!**
...
Whenever MERCURY transits in perigee in September, we see it BELOW the Sun (by about -3°, as viewed from the Earth).

Whenever MERCURY transits in perigee in March, we see it ABOVE the Sun (by about +3°, as viewed from the Earth).  
...
> _...“can come close together (i.e. return to the same place in space) as in 1951 and 1990 (i.e. within a ca. 39.5-year period)”_
