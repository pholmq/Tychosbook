...
The below image is from a 'mainstream' astronomy website. It shows that even our nearmost star, Proxima Centauri, is observed to proceed along a similar trochoidal path as Vega (albeit a much 'flatter' one, due to Proxima's different celestial latitude):
