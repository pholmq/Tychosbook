...
In the TYCHOS, Earth proceeds at 1.6km/h(or ≈1mph), covering an annual distance of ca. 14036km. You will note that this distance is just a little longer (by 1280km) than Earth's own diameter of 12756km. Since Earth also spins around its axis every 24 hours or so, it follows that the path traced by a man (standing still for a full year) will be a [trochoid](https://www.geogebra.org/m/pZdFncKB). A trochoid is simply a curve traced by a point fixed to a circle as it rolls along a straight line. So if we imagine a stationary man in London (let's call him "Jim") looking through his telescope for a full year, our Jim will be carried around a trochoidal path (Jim is patiently monitoring the annual motions of the star Vega). 
