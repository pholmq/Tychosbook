...
The Wikipedia entry on the ‘fine-structure constant’ [8]  informs us that Webb’s first, groundbreaking findings (published in 1999) described a minuscule variation in the Alpha constant. This variation in the constant amounted to about 0.0000057 of the 137 value, which allows us to the following math:
