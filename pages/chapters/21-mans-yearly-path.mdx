...
## THE TYCHOS - AND THE "137" NUMBER

As we just saw, the Sun is empirically observed to oscillate (from east to west) by as many as 31.44 minutes in relation to an ideal / fixed / virtual meridian (or solar apex) - and consequently, in relation to our earthly clocks. We may thus say that the _average_ ‘solar apex oscillation’ amounts to 31.44min / 2 = 15.72min.
...
355	724 597km / 2 594 872 km = **137.08**. In other words, the distance covered by the Earth in one Great Year is just about 137 times the daily distance covered by the Sun. 

Well, it so happens that this peculiar 1/137 ratio (or more precisely, 1/137.03599913) is one of the most famous and hotly-debated ‘mysteries of physics’.   
...
Without going into nuclear physics, which is well beyond the scope of this book, suffice to remind the reader that electrons are believed to revolve at high speeds around an atom's nucleus (in 1912, Niels Bohr proposed his now-famous model of the atom, where the electrons orbit around the atomic nucleus "much like planets orbit the Sun"). Today, theoretical physicists refer to the mysterious, more recently-discovered 1/137 ratio (or "alpha–α") as the "fine-structure constant" (or the "coupling constant") of the electromagnetic force that binds atoms together.
...
In the TYCHOS, of course, the Sun could be considered as the "electron" that revolves at high speed around the spinning "nucleus"(i.e. the Earth). As we saw above, **_for every diurnal rotation of the Earth, the Sun moves by a distance corresponding to 1/137th of the circumference of the Earth's inner orbit!_** Could this Sun-Earth 1/137-relationship be purely coincidental? Or may it perhaps go to explain and demystify this major and still-unsolved riddle which has our world's theoretical physicists scratching their heads?     

At this point, I dare say that we have a solid basis of evidence with which we may start to dismantle the heliocentric theory, once and for all. However, we first need to demonstrate - in methodical fashion - that some of our most celebrated scientists were all "at sea" as to the true geometric configuration of our Solar System. Yet, they are still hailed today for having _"definitively proven that Earth revolves around the Sun"_ - in absence of any experimental evidence in support of this contention. Two names come to mind: James Bradley - and Albert Einstein. In the next chapter, we shall see how the strange theories of these "icons of science" were based on illusory observations, fallacious interpretations and - quite literally - on thin air.     
