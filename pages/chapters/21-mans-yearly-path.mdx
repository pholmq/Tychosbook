...
![](https://septclues.com/TYCHOS/MANS_YEARLY_PATH_NEW_03.jpg)

A trochoid is simply a curve traced by a point fixed to a circle as it rolls along a straight line. So if we imagine a stationary astronomer in London (let's call him "Jim") looking through his telescope for a full year, our Jim will be carried around a trochoidal path (Jim is patiently monitoring the annual motions of the star Vega over a full year): 
