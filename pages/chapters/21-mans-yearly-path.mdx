...
In conclusion, as assessed within the TYCHOS paradigm, the "1/137 fine-structure constant Alpha" would not only seem to be 'reflected' by _the daily motion of the Sun_ (in relation to the "nucleus" / or "magnetic field of opposed polarity" represented by the Earth's orbital path), but its tiny observed variation would also appear to be 'reflected' _by the daily motion of the Earth itself!_ 
