...
In conclusion, it is not unreasonable to state that the true orbital periods of Jupiter and Saturn are respectively 12 years and 30 years. 
...
![](http://septclues.com/TYCHOS/Saturn_252days_01.jpg)

Here is how the JS orrery (a heliocentric simulator featuring an overhead view of our Solar System) depicts these two conjunctions:

![](http://septclues.com/TYCHOS/Saturn_252days_02.jpg)

And here is how the Tychosium3D depicts the same two conjunctions:

![](http://septclues.com/TYCHOS/Saturn_252days_04.jpg)

As you can see, the Tychosium shows Saturn returning to the exact same line of sight (and RA), whereas the JS orrery shows Saturn 'returning facing the same star' on two separate, parallel(?) lines of sight (Copernican advocates will argue that those two lines are _"not quite parallel"_).  

In any case, if the TYCHOS model is wrong, you will have to chalk up the fact that Saturn returns on the same line of sight to some random coincidence...

I will leave it up to the readers to judge for themselves which of the two simulators (the JS orrery or the Tychosium) makes the most sense. May no one ever accuse this author of trying to force upon the readers his own world view. All I wish is to share it with other thinkers - so as to start a thoughtful and intelligent debate as to which configuration of our Solar System best agrees with all empirical observations - as tirelessly gathered by our planet's astronomers throughout the centuries. One day, of course, I will leave this planet and my earthly life - but hopefully this book will remain available for future generations to assess and consider.   
