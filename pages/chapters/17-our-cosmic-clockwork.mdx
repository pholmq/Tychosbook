...
As you can see, the Tychosium shows Saturn returning to the same line of sight, whereas the JS orrery shows Saturn 'returning facing the same star' on two separate, parallel(?) lines of sight (of course, Copernican advocates will argue that those two lines of sight are _"not quite parallel"_).  
