...
Could the TYCHOS model possibly provide a simple and rational explanation for the apparent exponential increase of the equinoctial precession rate, you may ask. On pains of being repetitive, the answer to that question is ‘yes’. Figure 19.4 should readily clarify the issue.
...
Interestingly, Mars’ equatorial rotational speed would thus be 890 km/h, or 1.88 times slower than that of the Earth (1674 km/h), while its _average_ circumference is 1.88 times smaller than Earth’s. Also, as we saw in Chapter 5 (Fig. 5.1), Mars revolves _around the Sun_ in 687 days, or 1.88 x 365.25 days. 
