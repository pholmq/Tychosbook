...
However, we won't dwell too long over this 'colorful' character - other than to note that he went on to "disprove" Kapteyn's discoveries by saying, basically, that our Milky Way galaxy is far, far larger than previously believed. At the time, Shapley was assisted by some fellow theoretical astronomers (e.g. Jan Oort) who concocted a number of (entirely conjectural) theories which, basically, attempted to explain why some stars are seen to move in the opposite direction of other stars - _'due to their speed differentials around the galactic center'_(or something to this effect). In fact, it appears that we have to 'thank' Mr Shapley for having further inflated the size of our galaxy and the "cosmic insignificance of our Pale Blue Dot" (i.e. Earth). After which, the vexing question of Kapteyn's Star Streaming (which threatened to bring down the heliocentric cult) appears to have been definitively swept under the rug. 
