...
### HARLOW SHAPLEY - THE 'DESTROYER' OF KAPTEYN'S UNIVERSE

Now, _who_ was this Harlow Shapley fellow - whom we may well call "Kapteyn's hangman"? Let's start by reading a few selected extracts from his Wikipedia entry: 
...
However, we won't dwell too long over this disturbed character - other than to note that he went on to "disprove" Kapteyn's discoveries by saying, basically, that our Milky Way galaxy is far, far larger than previously believed. At the time, Shapley was assisted by some fellow theoretical astronomers (e.g. Jan Oort) who concocted a number of (entirely conjectural) theories which, basically, attempted to explain why some stars are seen to move in the opposite direction of other stars - _'due to their speed differentials around the galactic center'_ (or something to that effect). In fact, it appears that we have to 'thank' Mr Shapley for having further inflated the size of our galaxy and the "cosmic insignificance of our Pale Blue Dot" (i.e. Earth). After which, the vexing question of Kapteyn's Star Streaming (which seriously threatened to bring down the entire heliocentric edifice) appears to have been definitively swept under the rug. 

All of this goes to highlight how the best scientific discoveries of this world's most earnest and qualified researchers (such as Jacobus Kapteyn) can be eclipsed by the destructive antics of low-life psychopaths (such as Harlow Shapley) who, most probably, enjoy the support and backing of the higher spheres of political / masonic / kabbalistic power (call it what you will).  
