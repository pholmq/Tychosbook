...
NOTE: the latter category (3) is not something we will be concerned with here, since they are nothing but unrelated stars (a closer one and a much more distant one) which just happen to be aligned on our line of sight.
...
This epic feud between the two eminent astronomers (and binary-star experts) really deserves to be recounted, so here we go. What follows is an extract from the Wikipedia which briefly summarizes the long-lasting Van de Kamp / Wulff Heintz dispute (warning: all information published on Wikipedia concerning historical controversies ought to be taken with a grain of salt. As they say, "read between the lines"!):    
...
Indeed, it now turns out that Heintz was wrong and that Van de Kamp was right all along! In November 2018, ESO (the ground-based European Southern Observatory) announced:
...
One may rightly wonder why such diverse, spirographic barycentric motions would possibly be observed if the stars were several "light years" away - and if they all are (as currently believed) the central and super-massive body of all the 'solar systems' of our Milky Way, all revolving 'in unison' around its centre - at the claimed hypersonic speed of 800,000 km/h... And this, in spite of the fact that the proper motions of all our surrounding binary stars (revolving in "local orbits" around each other) are observed to proceed in every conceivable direction ("x,y,z") in our three-dimensional cosmos! As William Shakespeare would probably say: _"Something is rotten in the state of Denmark!"_ Yet, I would submit that the Danish astronomer Tycho Brahe played no part in this decay - on the contrary!  

In light of the information and considerations expounded in this chapter, I hope that the notion of the Sun and Mars being a binary pair may emerge (at least from a statistical / probabilistic point of view) as a sound and viable proposition. As you may agree, that child's question remains worthy of consideration: _"Dad, if all the stars have a companion, WHY would our Sun **not** have one?"_
