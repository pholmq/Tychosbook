...
Another random coincidence, perhaps? In any case, it would certainly appear that a number of independent yet congruent interferometer experiments (subsequent to the 'triumph' of Einstein's theories) have been wrongfully 'swept under the rug' by the world's scientific community.

- NONE of the various interferometer experiments produced "null" results. Hence, Einstein's GR was experimentally falsified.

- NONE of the results obtained, however, indicated _anywhere near_ the supposed hypersonic speed of Earth around the Sun ("30km/s").

-   

Since the Earth only moves at 1.6 km/h, covering only 7018 km every six months and 14036 km annually, we can now understand why it has been so difficult to detect its relative orbital speed,  stellar parallaxes. As it is, almost all astronomy debates and controversies over the last few centuries have been centered around minuscule variations or 'inequalities'. It’s time to start asking ourselves whether these infinitesimal celestial motions are due, quite simply, to the slowness of the Earth's own snail-paced motions. I suggest we should all get up to speed (pun intended) about the tranquil pace of our planet; after all, this blissful slowness may well be an essential prerequisite to the very existence of life on Earth. 
