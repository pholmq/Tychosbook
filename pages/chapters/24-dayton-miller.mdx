...
Another random coincidence, perhaps? You be the judge. In any case, it would certainly appear that a number of diverse yet congruent - and thus significant - interferometer experiments (subsequent to the 'triumph' of Einstein's theories) have been ignored or 'overlooked' by the world's scientific community. We may thus summarize the current state of affairs concerning the various attempts at measuring the Earth's translational speed:  
...
- The results obtained by various interferometer experiments (with regards to the detections of what were interpreted as _diurnal variations_ of the speed of light) would seem to support the TYCHOS model's proposed speed of 1.6km/h.  
