...
Since Earth only moves at 1.6 km/h, covering only 7,018 km every six months and 14,036 km annually, we can now understand why it has been so incredibly difficult to detect its relative orbital speed, along with any stellar parallaxes. As it is, almost all astronomy debates and vivid controversies over the last few centuries have been revolving around miniscule variations or 'inequalities'. It’s time for us earthlings to stop arguing about petty matters. We all need to get up to speed (pun intended) about the wonderful slowness and tranquil spatial motion of our planet. In fact, my guess is that there would be no life on Earth without this blissful slowness.
