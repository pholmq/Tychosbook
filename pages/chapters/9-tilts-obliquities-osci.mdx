...
What follows is something that will require the reader to return to later on (in a second reading) - in order to fully appreciate its remarkable nature and significance. For now, suffice to say that the TYCHOS model submits that Earth's orbital diameter is 113.2Mkm-wide (i.e. the "PVP orbit" which will be expounded in Chapter 11). Venus has, of course, always been considered as "the Earth's sister" - since its dimensions are almost identical to the Earth (Ø of Venus: 12103.6km - and Ø of the Earth: 12756km). As illustrated above, the Earth-Sun distance varies by about 5Mkm between winter and summer. Now, the _average_ Sun-Venus distance (according to all official estimates) is 108.2Mkm. Well, since Venus is a moon of the Sun (as posited by the TYCHOS), it will also oscillate (in relation to the Earth) by 5Mkm between summer and winter. In other words, the maximal Venus oscillation will add up to 108.2Mkm + 5Mkm, for a total of 113.2Mkm - i.e _by the exact diameter of the Earth's "PVP orbit!..._         
