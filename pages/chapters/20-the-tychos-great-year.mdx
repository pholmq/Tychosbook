...
As of the best astronomical observations, Mars appears to rotate once around its axis every 24.6229 hours. Earth’s sidereal day is 23.9345 hours. This is a difference of 41.3 minutes. The question is: why would its axial rotation period _almost precisely_, yet not quite, match that of Earth’s? Could perhaps Mars’s rotation around its axis be, in actuality, _synchronous_ with Earth’s rotation rate? Let’s see if we can find any indications in support of this hypothesis.
...
As Mars completes one of its habitual 707-day revolutiom around the celestial sphere, its 'perceived' orbital speed will be 84575.6km/h. Mars would therefore employ roughly 41 minutes to "catch up" with the earthly observer:

56625km / 84575.6km/h = 0.6695h (or about 40.2 minutes). 

Thus, Mars will only _appear_ (to an earthly observer) to rotate around its axis slower than Earth, since each year, he will be offset by that amount in relation to Mars’s celestial position. He will thus erroneously conclude that Mars rotates around its axis about 41 minutes slower than Earth.

All this suggests that, remarkably enough, Mars and Earth rotate around their respective axes in the same amount of time! 

My below graphic illsutrates how Joe (our earthly observer) will erroneously conclude that Mars rotates around its axis slightly slower than Earth; the green dot marking a given point on the Martian surface will be seen by Joe from another angle after 2 years, but in reality, Mars has returned to the same rotational orientation in space it had two years earlier:

![](https://www.tychos.info/book_imagery/120_TYCHO_SSSS_geoaxial_Mars_Earth_02.JPG)

It is worth noting that Mars’s rotational speed around its axis would therefore be 891.5 km/h, which is 1.88 X slower than Earth’s rotational speed of 1676 km/h. As it is, Mars revolves once _around the Sun_ in 686.9 days (on average) - or almost exactly 365.25 days X 1.88 !
