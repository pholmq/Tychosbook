...
In other words, it would appear that the magnetic reversals of the Sun and the Earth are regulated by - and are commensurate to - their respective orbital speeds! Another way to put it would be: 

- Earth's orbital speed is 66967.3 X slower than the Sun's orbital speed (107226 / 1.601169 ≈ 66967.3)
- Earth's magnetic reversals occur 66967.3 X less frequently than the Sun's magnetic reversals (781000 y / 11.6624 y ≈ 66967.3)

This sort of remarkable realization is, of course, only possible when viewed through the 'TYCHOS lens'. In absence of any 'official' explanations for the vastly different recurrence rates of the Earth's and the Sun's magnetic reversals, one may say that the TYCHOS model "wins by default", much like when a basketball team fails to show up at a tournament... In the next chapter, we shall see how the TYCHOS can elucidate a number of further aspects related to the motions of the Earth and the Sun - and the optical implications of the same.
