...
As of the best astronomical observations, Mars appears to rotate once around its axis every 24.6229 hours. Earth’s rotates around its axis in about 23.9345 hours (our sidereal day). This is a difference of roughly 41 minutes. One may rightly wonder: why would the rotational periods of Earth and Mars be so similar? Could perhaps Mars’s rotation around its axis be, in actuality, _synchronous_ with Earth’s rotation rate? Let’s see if we can find any indications in support of this fascinating hypothesis.
...
14036 km X 4.034266 ≈ 56625 km

56625 km is 0.0039457% of Mars’s orbital circumference of 1 435 079 524 km (NOTE: this would be the 'external' circumference of the Martian orbit - i.e. not inclusive of its bi-yearly retrograde loop, as explained and illustrated at the end of Chapter 5).   

As Mars completes one of its _habitual_ 707-day revolutiom around the celestial sphere, its _perceived_ orbital speed will be 84575.6km/h. As computed below, Mars would therefore employ roughly 41 minutes to "catch up" with the earthly observer:

56625km / 84575.6km/h = 0.6695h (or about 40.2 minutes). 

Thus, Mars will only _appear_ (to an earthly observer) to rotate around its axis slower than Earth, since each year, he will be offset by that amount in relation to Mars’s celestial position. He will thus conclude that Mars rotates around its axis about 41 minutes slower than Earth.

All this suggests that, remarkably enough, Mars and Earth may indeed rotate around their respective polar axes in the same amount of time! 

My below graphic illustrates how Joe (our earthly observer) will erroneously conclude that Mars rotates around its axis slightly slower than Earth; the green dot marking a given point on the Martian surface will be seen by Joe from another angle after 2 years, but in reality, Mars has returned to the same rotational orientation in space it had two years earlier:

![](https://www.tychos.info/book_imagery/120_TYCHO_SSSS_geoaxial_Mars_Earth_02.JPG)

It is also worth noting that Mars’s rotational speed around its axis would therefore be 891.5 km/h, which is 1.88 X slower than Earth’s rotational speed of 1676 km/h. As it is, Mars revolves once _around the Sun_ in 686.9 days (on average) - or almost exactly 1.88 X 365.25 days!

In conclusion, Mars may well rotate around its axis in the very same amount of time as Earth. The significance of this is unclear, but it would certainly seem to jar with the notion that Mars and Earth are just two 'random planets' revolving around the Sun - as of the heliocentric theory. 
