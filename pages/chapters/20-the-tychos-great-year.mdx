...
As of the best astronomical observations, Mars appears to rotate once around its axis every 24 hours 37.5 minutes. Earth’s sidereal day is 23 hours 56 minutes. This is a difference of **41.5 minutes**. The question is: why would its axial rotation period _almost precisely_, yet not quite, match that of Earth’s? Could perhaps Mars’s rotation around its axis be, in actuality, _synchronous_ with Earth’s rotation rate? Let’s see if we can find any indications in support of this hypothesis.

Each year, as we have seen, Earth covers 14036 km or **0.0039457%** of the total PVP orbit.

Since the 'external' circumference of Mars' orbit is 4.034266 X larger than Earth’s orbit, this will correspond to a segment of Mars’s orbit equal to:

14035.847 km X 4.034266 ≈ 56624.34 km

56624.34 km is 0.0039457% of Mars’s orbital circumference of 1 435 079 524 km (IMPORTANT NOTE: this would be the 'external' circumference of the Martian orbit - i.e. not inclusive of its periodic retrograde loops, as explained and illustrated at the end of Chapter 5).   

At its perceived orbital speed of 81854.866 km/h Mars will in fact employ ca. 41.5 minutes to cover the extra 56624.34 km as it “catches up” with the displacement of an earthly observer: 56624.34km / 81854.866km/h = 0.691765h (or 41.506 minutes).
...
Hence, and in conclusion, Mars most likely rotates around its axis in the very same time as Earth: 23 hours 56 minutes (i.e. one “sidereal day”). The significance of this is unclear, but it would certainly seem unsupportive of the idea that Mars and Earth are just two 'random planets' revolving around the Sun - as of the heliocentric theory.
