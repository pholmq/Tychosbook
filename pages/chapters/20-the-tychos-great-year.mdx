...
Now, if the Sirius system were to be our Solar System’s binary companion, it would make sense that its ‘long orbit’ is of similar size to ours. Hence, for my geometric experiment, I chose to draw two ‘wheels’ of equal size divided in 16 slices of 50688 years (50688 X 16 ~ 811000), overlapping the two in classic binary fashion. Incidentally, and as you may recall from Chapter 16, 50688 years (i.e. 2 X 25344) is the “Great Year of Mars”. 
...
In the TYCHOS model, the Earth’s orbital speed (1.601169 km/h) is a mere 0.00149326% of the Sun’s orbital speed (107226 km/h). So let’s see how this pans out mathematically - with regards to the respective magnetic reversals of the Sun and the Earth:
