...
Ratio between the Sun’s orbital diameter and the PVP orbit = 2.64233
...
This further corroborates our demonstration in Chapter 10, showing that the observed precession has nothing to do with the heliocentrists’ hypothetical ‘lunisolar wobble’. As a final confirmation that these 20.41 minutes also correspond to a portion of the Earth’s axial rotation, we see that 18369” amounts to 1.4173% of 1 296 000” (i.e. 360°); as the Earth rotates at 1674 km/h, it will rotate by 568 km in 20.41 minutes. And in fact, 568 km amounts to 1.4173% of 40075 km (the Earth’s equatorial circumference). 
