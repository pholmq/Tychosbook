...
Note in my above graphic that the lengths A and B (representing two of the most well-known precessional measurements in astronomy) are perfectly consistent, proportionally speaking. You may verify for yourself, with a simple school ruler, that length B is 1.25 X larger than length A (since 50.3” is 1.25 X larger than 40”). The 50.3" value represents, of course, the observed annual general precession. Since these commensurate values rely on the core principles of the TYCHOS model (what with Earth’s annual 14036-km-motion & the trochoidal path of earthly observers), the odds for all this to be entirely coincidental are, objectively speaking, beyond rational consideration.

The almost comical “stellar aberration” theory which Bradley concocted (in his urge to justify otherwise inexplicable observations) has to be among the most contorted attempts at rescuing the Copernican model from its inevitable demise. As a matter of fact, Bradley's theory was subsequently falsified by his illustrious colleague George Airy, who filled a telescope with water and showed that no variation of the 'aberration' could be observed (viz. "Airy's Failure"). In hindsight, it is ironic that Bradley’s enterprises very nearly ended up demolishing heliocentrism "from within", so-to-speak, since his (otherwise indisputably accurate) observations were in stark contradiction with the 'Copernically-expected' stellar motions.

Here are some interesting statements we may read at the 'Explaining Science' website: 
...
Pardon me?... If 'stellar aberration' _does not vary with distance_, how could it possibly have any relation with the speed of light? Once more, the obvious answer to this question is that "stellar aberration" has nothing to do with star light! Instead, it must necessarily be a _local / terrestrial_ motion which affects all the stars equally; namely, the ever-looping frame of reference that all earthly observers are subjected to - as they revolve annually around a trochoidal path (see Chapter 21).    

### EINSTEIN'S SPECIAL & GENERAL RELATIVITY: BUSTED
...
In his conclusions, Russo clearly laments about the SRT's "lack of adequate physical explanations" for the observed 'stellar aberration':    
...
So much for Einstein's Special Relativity Theory. Let's now take a look at his famed General Relativity (GR) theory.
...
Now, let's see how the TYCHOS model can account for these allegedly 'anomalous' 43" of Mercury's precession - in the simplest imaginable manner:
...
**In other words, the purported "ANOMALIES" were nothing but the NATURAL precession rates of Mercury and Venus!** 
...
In what must be the funniest twist of this 'cosmic puzzle' (i.e. the so-called _"anomalous precession of Mercury's perihelion"_), it can be rightly remarked that the whole affair **actually proved that the Sun and its two moons (Mercury & Venus) all revolve around Earth, and not the other way round!** 
...
All the same, this 'experimental result' established (in the eyes of the public) Albert Einstein as the N°1 scientist of our times. 

In conclusion, there never was any anomaly in either Mercury's or Venus's precessional motions. Likewise, there never was any 'aberration of starlight'; Bradley's and Einstein proposed explanations thereof were not only contradictory: they were fundamentally flawed and cannot therefore be held as proof of Earth's purported motion around the Sun. As for Eddington's observational data collected during his 1919 expeditions, they have been shown to be anything but conclusive by numerous subsequent analytical reviews.
