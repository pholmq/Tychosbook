...
Fig. 22.6 shows how the TYCHOS can readily account for Bradley’s imagined ‘nutation’, with no need for any wobble of the Earth’s polar axis: the green area illustrates the length (14036 km) and width (12756 km) of the elliptical ‘zone’ within which an earthly observer gyrates annually (corresponding to the EAM and Earth’s diameter, respectively). The ratio of this ellipse is ~1.1:1 (14036 / 12756 = 1.1), which is another way of saying that its major axis and minor axis differ by 9.5%. As of the Wikipedia, Bradley’s flattened ellipse was 18" by 16", but other sources have the major axis at 17.6". An ellipse of 17.6" by 16" does in fact have a 1.1:1 ratio (17.6 / 16 = 1.1), equivalent to a 9.5% difference between the axes. Hence,  Bradley’s  
observed ‘nutation’ was in all likelihood an optical illusion, not an eerie axial wobble. Nonetheless, we must thank Sir Bradley for unwittingly providing further corroboration of ‘a man’s yearly path’, as defined by the TYCHOS model (Chapter 21). 
