...
_"The greatest apparent displacement of the star being observed should have been found between observations six months apart, when the locations of the observations were furthest apart. The actual displacements, however, followed a completely different pattern and were clearly not due to parallax. The Pole Star, Polaris, for example, was found to follow a roughly circular path, with a diameter of about 40 arc seconds (40”)."_ ["What is the Aberration of Light?" - by Phil Riddel (2023)](https://www.allthescience.org/what-is-the-aberration-of-light.htm#:~:text=In%20astronomy%2C%20the%20aberration%20of,for%20observers%20on%20the%20Earth.) 
