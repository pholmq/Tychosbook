...
- On March 10, 1834 The Tychosium simulator has Halley's comet transiting at about 21.3h of RA on March 10, 1834.**

_(*/** - Note: as of mid-2022, Halley's orbital parameters in the Tychosium 3D simulator are still provisional - yet they are already quite useful as a 'proof of concept' of cometary orbits in the TYCHOS model. The Tychosium is a work in progress - but we are confident to further improve its accuracy over time - given more development, patience and human working hours!... _ 

Since both "Dunlop's and Gambart's" comets were observed to move in _prograde_ direction, they were - again - therefore quickly dismissed (or never even considered) as being possible approaches of Halley's comet (which is believed to always move _retrograde_, i.e. in the opposite direction of our planets). Nevertheless, it should be self-evident that “Dunlop’s and Gambart's" comets of 1833 and 1834 were, in all likelihood, none other than Halley’s comet.  
...
The Tychosium simulator has Halley’s comet passing our planet at close distance (circa 0.2AU), right between the Earth and the Sun on 1910-05-20 (in Taurus), just as recorded and documented in the historical astronomy annals.
...
Quite clearly, the reason why astronomers failed to realize that the "Great Daylight Comet" and Halley's comet were one-and-the-same (even though they were separated by only a few months!) is due to their misunderstanding of the comet’s orbital motions - which of course is a corollary of their ill-founded belief in the heliocentric configuration of our solar system.

**"MACHHOLZ'S COMET" OF 1985**

We shall now take a good look at the very last transit(s) of Halley's comet in 1985/1986. Hold on to your seats dear readers, for what follows will - I dare say - provide _definitive & incontrovertible proof_ in support of the TYCHOS model's proposed celestial motions of our most famous comet.   

Before we start, please keep in mind that the latest passage of Halley's comet around April 1986 was, notoriously and by all accounts, a "terrible disappointment". The comet was barely visible with the naked eye and those who got a glimpse of it described it as a faint speck of light (with a minuscule tail). Now, since the Tychosium simulator has Halley's comet also passing very close to Earth about ten months earlier (in mid-1985), I was naturally drawn to investigate whether any observational astronomers had seen it (around mid-1985 - as it passed between the Sun and Earth). Sure enough, I soon found out that an eminent observational astronomer (and accomplished comet hunter), Donald Machholz, had observed a comet in that area of our skies in 1985. In fact, the comet he observed now bears his name: **"C/1985 K1 Machholz"**.
...
So let's see: "Machholz's 1985 comet" was _extremely close to the Sun_; it was expected to reach 4a to 5a (i.e. within naked-eye view - the threshold of which is around 6a); however, this never happened: after being viewed (telescopically) at 7.6a in the first half of June it disappeared from view and was only observed in the infrared a short while later. Most importantly, please note that Machholz's 1985 comet is described as a "non-periodic" comet: in other words, no one knows if it will _ever_ return in our skies... We are thus left to believe that the "Machholz 1985 comet" just passed - by sheer coincidence - very close to the Earth in mid-1985 - just around the time that Halley's comet was expected to arrive in our skies - never to return again! 

Let us now compare two screenshots from the Tychosium simulator (HALLEY's comet) and the JPL/NASA simulator ("MACHHOLZ's" comet).

**In the Tychosium simulator**, on May 27 1985 (i.e. on the day Machholz discovered "his comet"), we find that Halley's comet was located fairly close to 0 hours of RA (celestial longitude), at 23h27m. Halley's then proceeded to transit in front of the Sun. On July 12, 1985 it passed very close to our planet (yet was most likely swamped in the Sun's glare) - and was pretty much aligned with Mercury (as viewed from Earth):

![](https://septclues.com/TYCHOS/Halley_MACHHOLZ_comet_TYCHOSIUM_01.jpg)

On the other hand...

**In the JPL/NASA simulator**, on May 27 1985, we find that "Machholz's comet" was located fairly close to 0h of RA (celestial longitude), at 0h47m. It then proceeded to transit behind the Sun (according to the official reckoning). On July 12, 1985 it was pretty much aligned with Mercury (as viewed from Earth):

![](https://septclues.com/TYCHOS/Halley_MACHHOLZ_comet_JPL_NASA_01.jpg)

On 1985-08-05 the Tychosium 3D simulator has Halley's comet at RA:13h22m and DECL:+4°55'

On 1985-08-05 the JPL Small Body Database has "Machholz's 1985 comet" at RA:13h24m and DECL:+06 43

Evidently, and once again, the comet that Donald Machholz observed in 1985 was none other than Halley's comet! One may perhaps dispute the fact that "Machholz's comet" was reckoned to transit _behind the Sun_ (whereas the Tychosium has Halley's comet _in front of the Sun_); however, it is up for everyone to judge for themselves whether this was yet another "Coincidental Comet' that just happened to pass close to Earth just as Halley's comet was expected to arrive - in a manner largely consistent with that predicted by the Tychosium simulator.   
...
The final section of this chapter will be concerned with 


**MOROZOV'S DATING OF THE "APOCALYPSE" (John: Book of Revelations)**


The most compelling historical revision submitted by the Russian astronomer Nikolai Morozov is to be found in his book _"The Revelation in Storm and Thunder. History of the Apocalypses origin"_ (1907). The book's German version is titled "The Revelation to John - An astronomic historical Investigation").

Morozov makes the case that the Book of Revelation is describing the astronomical constellation over the island of Patmos on Sunday, September 30, 395. Morozov believed that "John the Revelator" was able to calculate the Saros eclipse cycle and was able to observe and predict celestial phenomena which would have occurred in the region of the skies of Patmos. In his book, the controversial Russian astronomer determines with exacting precision that what "John the Revelator" refers to (in his colorful, metaphorical and only apparently "cryptic" description of celestial events) had to have occurred on September 30, 395 - just as a solar eclipse occurred.
