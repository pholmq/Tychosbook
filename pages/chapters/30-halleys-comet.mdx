...
Here follows a list of ancient cometary sightings (reported in the literature) which would seem to be in agreement with the Tychos roster of Halley’s passages. 
...
In this other book, Pontécoulant (the top French expert of comet Halley’s at the time) also mentions the comet's 550 AD passage:
...
Note that NONE of these three passages are to be found in the current, official roster (which has Halley's passing instead in 374, 451 and 530).
