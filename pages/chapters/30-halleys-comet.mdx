...
I trust that the attentive reader will sense where I am going with this; but there is more - much more - to come. Let's proceed one step at a time and see what happened around the next passage of Halley’s comet in 1835. Two comets were observed in 1834 and in 1833, 'coincidentally' only one and two years before Halley's 'official' 1835 passage. As it is, the Tychosium simulator can show that both of these comets were none other than Halley's comet. If you are fluent in French, you may wish to read this French paper about the comets of 1833 and 1834: ["Sur les orbites des deux comètes de 1833 et 1834" - by L. Schulhof (1889)](https://www.persee.fr/doc/bastr_0572-7405_1889_num_6_1_10221) 
...
To wit, since both "Dunlop's" and "Gambart's" comets were observed to move in _prograde_ direction, they were never considered as being possible 'early sightings' of comet Halley. However, the Tychosium simulator clearly indicates that both of them were, in fact, none other than Halley's comet. In any case, the so-called Dunlop and Gambart comets are now listed in astronomy textbooks as "non-periodic", meaning that they have only ever been observed _once_, and that no one knows if they will ever return again! As some will say, 'you couldn't make this up'.
...
Let us now take a look at comet Halley’s 1910 passage which caused quite a stir: the newspapers of the time ran horror stories about how the Earth would be enveloped by the comet's tail (thought to contain deadly hydrogen cyanide) - and that we were all going to die.
...
This chapter's final section will take a look at a theory submitted years ago by one of the most 'eccentric' astronomers and history revisionists that the world has ever known, namely Nikolai Morozov. The most compelling historical revision submitted by Morozov is to be found in his book _"The Revelation in Storm and Thunder. History of the Apocalypses origin"_ (1907). The book's German version is titled _"The Revelation to John - An astronomic historical Investigation"_).
