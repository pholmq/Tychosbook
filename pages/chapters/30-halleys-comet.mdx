...
But let us start from the beginning of this pivotal - and dreadfully ruinous - case of misidentification: on November 14, 1680, the German astronomer Gottfried Kirch saw an object in his telescope that was ultimately interpreted as a comet. In reality though, Kirch was doubtful about its cometary nature, as he never observed any tail trailing the object (a rather dull speck of light which he first thought was some never-seen-before nebula). Here’s an extract from a paper titled “First discovery of the Great Comet of 1680”:
...
In short, Kirch saw a faint object fairly close to Mars - moving prograde across the skies; other observers (e.g. Brattle and Foster) also reported that same dull object (of November 1680). Here’s a brief extract from a Harvard.edu paper:
