...
A notorious controversy between Newton and Flamsteed centred upon the nature of the successive sightings of 1680 and 1681 of what was eventually (yet, as we shall see, erroneously) deemed to have been the very same comet. It would appear that Sir Isaac was initially perplexed (and rightly so) about the "extraordinary hairpin turn" that the comet must have made - if Flamsteed's 'same comet theory' were correct: 

![](https://septclues.com/TYCHOS/Halley_Newton_Flamsteed_controversy_01.jpg)

But let us start from the beginning of this pivotal - and dreadfully ruinous - case of misidentification: on November 14, 1680, the German astronomer Gottfried Kirch first saw an object in his telescope (at roughly 10h of RA and close to Mars) that was ultimately interpreted as a comet. In reality though, Kirch was doubtful about its cometary nature, as he never observed any tail trailing that object (a rather dull speck of light which he first thought was some never-seen-before nebula). Here’s an extract from a paper titled “First discovery of the Great Comet of 1680”:
...
In short, Kirch saw a faint object close to Mars, moving prograde across the skies. Other observers (e.g. Brattle and Foster) reported that same dull object of November 1680 and, only a month or so later, also reported a far brighter object (with a distinct tail) in the opposed part of our skies. Here’s a brief extract from a Harvard.edu paper:
...
As we saw above, the first sighting of the so-called "Great Comet of 1680" (a.k.a. "Newton's Comet") was a case of mistaken identity: it was, in actuality, asteroid Eros. History books then report that the final telescopic observation of this comet occurred on March 19 (1681), _"by which time its heliocentric distance had increased to 2.2 AU - and was made by none other than the eminent British physicist Isaac Newton"._ ["Comet of the Week: The Great 1680 Comet" - by Alan Hale (2020)](https://www.rocketstem.org/2020/12/12/ice-and-stone-comet-of-week-51/) 

Halley's comet was then observed in 1682 as it passed very close to the Earth - and yet another sighting of a (non-identified) comet was made by Robert Hooke on August 20, 1683. The Tychosium simulator can show how each one of those reported sightings (of "other comets") surrounding Halley's 1682 passage were nothing but misidentified sightings of Halley's comet itself. Note that, according to the Tychosium, Halley's comet would have indeed been transiting at roughly 2.2 AU or so from the Sun on March 19, 1681 - just as mentioned in the above-referenced article by Alan Hale.   

![](https://septclues.com/TYCHOS/HALLEY_1680-1681-1682-1683_01.jpg) 
...
The Tychosium also has Halley’s comet passing closest to Earth (on April 26, 1759 / 9:30 UTC) at **0.1225AU**!
...
Source: [“Catalog of Comets (1800-1899)" - by Kronk, Meyer and Seargent]
