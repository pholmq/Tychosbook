...
On August 5 2005 the Tychosium 3D simulator has Halley's comet at RA: 13h22m and DECL: +4°55'

On August 5 2005 the JPL Small Body Database has "Machholz's 1985 comet" at RA: 13h24m and DECL: +06 43

Evidently, and once again, the comet that Donald Machholz observed in 1985 was none other than Halley's comet. One may dispute the fact that "Machholz's comet" was reckoned to transit _behind the Sun_ (whereas the Tychosium has Halley's comet _in front of the Sun_); however, it is up for everyone to decide for themselves whether this was yet another "Coincidental Comet' that just happened to pass close to Earth just as Halley's comet was expected to arrive - in a manner consistent with that predicted by the Tychosium simulator.   
