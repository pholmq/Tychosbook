...
In fact, the most spectacular meteor shower in recent memory took place in 1833, making people wonder if it was a sign of the end of the world. As shown in Figure 30.36,  the path of Halley’s comet as it passed closest to Earth in the autumn of 1833 was near-identical to its path in the autumn of 395 AD, the two events being separated by 1438 years (i.e. ≈19 x 75.7y). Once more, the Tychosium can account for two unforgettable historical events connected to Halley’s comet.
