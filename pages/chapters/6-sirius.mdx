...
As you can see in the above table, Sirius has “precessed” in 4000 years (from 3500 BC to 500 AD) by only about four days (from July 16.4 to July 20.3). [p. 50,_"The heliacal rise of Sirius and ancient Egyptian chronology"](http://adsabs.harvard.edu/full/2000JHA....31..149S) by Bradley E. Schaefer for _Journal for the History of Astronomy_, Vol. 31, Part 2, p. 149 – 155, Yale University
...
3: It would elucidate why various ancient civilizations used Sirius as a stable / reliable reference around which they based their all-important calendars - and even used its heliacal rising to mark their New Year date.
