...
Every solar year (of 365.2425 days), we see the Sun seemingly 'slipping westwards' against the starry background by slightly less than 1 minute (of RA). In four years, this would add up to an apparent 'solar westward drift' of about 3.93 minutes (of RA). Therefore, every four years - i.e. every 'leap year' - an extra day is added (February 29) in order to try and 'compensate' for the Earth's motion around its PVP orbit. Here follows an illustrated demonstration as to exactly how this plays out in the physical world.  
...
Now, each day the Earth's axial rotation "ticks" (counter-clockwise) by just about 3.93 min as it "follows" the Sun's (counter-clockwise) yearly orbit around us (note that 1436 min, i.e. one sidereal day, divided by 365.2425 days (i.e. one solar year) = 3.93 minutes. Hence, by adding one day to our calendar every four years, the Earth will rotate by an extra 3.93 minutes - while the Sun will move eastwards in our skies by an extra 2.566 Mkm or so.  
