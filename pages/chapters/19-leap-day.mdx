...
However, the Wikipedia’s entry on the [“Sothic cycle”](https://www.tychos.info/citation/_WIKIP-Feb-2017_Sothic_cycle.pdf) provides us with this :
...
Every solar year (of 365.2425 days), we see the Sun seemingly 'slipping westwards' against the starry background by slightly less than 1 minute (of RA). In four years, this adds up to an apparent 'solar westward drift' of about 3.9316 minutes (of RA). Therefore, every four years - i.e. every 'leap year' - an extra day is added (February 29) in order to try and 'compensate' for the Earth's motion around its PVP orbit. Here follows the full mathematical and illustrated demonstration as to exactly how this plays out in the physical world.  

As seen from the Earth, the subtended length of a 3.9316 min "slice" of the Sun's orbit translates into a distance of about 2 566 300 km, because:
...
Now, each day the Earth's axial rotation "ticks" (counter-clockwise) by just about 3.9316 min as it "follows" the Sun's (counter-clockwise) yearly orbit around us - because 1436 min (one sidereal day) divided by 365.2425 (the days contained in one solar year) = 3.9316 minutes. Hence, by adding one day to our calendar every four years, the Earth will rotate by an extra 3.9316 minutes - while the Sun will move eastwards in our skies by an extra 2.57 Mkm or so.  
...
As can be verified at the [TYCHOSIUM simulator](https://ts.tychos.space/), these were the celestial longitudes (RA) of the Sun on June 21 in the years 2000 through 2004:
...
To wit, the Sun appears to "retrograde" by 1 minute each year - only for the leap year to 'reset' its original position at virtually the same longitude (but not quite) in the sky. One could say that the "leap day gimmick" (i.e. the addition of February 29 every four years or so) is a 'vain combat against the general precession', and an ultimately doomed attempt at countering the slow - yet unstoppable - clockwise motion of the Earth around its PVP orbit. The reason for its very existence is of course due to the wish of 'stabiizing' the recurrence of our (mostly religious) festivities and celebrations. Easter, for instance, was a problem back in the days - as the Julian calendar (which took effect on January 1st, 45 BCE) had made its recurrence 'slip' by about 11 days. Thus, the Gregorian calendar was introduced in October 1582 by Pope Gregory XIII - and is still the one we use today. However, it is now widely recognized that even the Gregorian calendar count is problematic...        

> "Experts note that the Gregorian calculation of a solar year - 365.2425 days - is still not perfect, and thus another correction will be necessary. Thankfully, the Gregorian calendar is only off by about one day every 3,030 years, so mankind has some time before this becomes a problem". [5 Things You May Not Know About Leap Day](https://www.history.com/news/why-do-we-have-leap-year)

The question of the "true" and exact duration of our solar years is therefore far from settled. This should not come as a surprise though, since this world's scientific community still believes that the Earth revolves around the Sun and have never, of course, taken into account Earth's PVP orbit - as posited by the TYCHOS model.  
