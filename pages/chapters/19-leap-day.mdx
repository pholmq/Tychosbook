...
As it is, 2 566 300 km is almost precisely the distance covered by the Sun during one sidereal day (107266 km/h X 1436 min ≈ 2 566 276 km)  

Now, each day the Earth's axial rotation "ticks" (counter-clockwise) by just about 3.9316 min as it "follows" the Sun's (counter-clockwise) yearly orbit around us, because: 1436 min (one sidereal day) divided by 365.2425 (the days contained in one solar year) = 3.9316 minutes. Hence, by adding one day to our calendar every four years, the Earth will rotate by an extra 3.9316 minutes - and the Sun will move eastwards in our skies by an extra 2.57 Mkm or so.  
...
To wit, the Sun appears to "retrograde" by 1 minute each year - only for the leap year gimmick to 'reset' its original position at virtually the same longitude (but not quite) in the sky. One could say that the addition of February 29 every four years is a 'vain combat against the general precession', and an ultimately doomed attempt at countering the slow - yet unstoppable - clockwise motion of the Earth around its PVP orbit. 
