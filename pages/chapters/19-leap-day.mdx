...
As it is, 2 566 300 km is almost precisely the distance covered by the Sun in one sidereal day (107266 km/h X 1436 min ≈ 2 566 276 km)  

Now, each day the Earth's axial rotation "ticks" (counter-clockwise) by just about 3.9316 min as it "follows" the Sun's (counter-clockwise) yearly orbit around us, because: 1436 min (one sidereal day) divided by 365.2425 (the days contained in one solar year) = 3.9316 minutes

As ever, a picture can tell more than a thousand words - and I trust that my below conceptual graphic will neatly clarify the issue: 
