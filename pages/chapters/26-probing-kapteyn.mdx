...
As illustrated in my below graphic, what Esclangon observed - and called a "dissymmetry of space" - was simply caused by Earth's 1.6km/h motion, _perpendicular to the star quadrants "A" and "B"_. The other two star quadrants ("C" and "D") were not affected by Earth's motion since we move at all times either _away_ from quadrant "C" - or _towards_ quadrant "D":
