...
As illustrated in my below graphic, what Esclangon (unwittingly) observed - and called a "dissimetry of space" - was simply due to Earth's 1.6km/h motion perpendicularly to the star quadrants "A" and "B". The other two quadrants ("C" and "D") were not affected since we move at all times either away from quadrant "C" - or towards quadrant "D"; hence, they will not exhibit any dissimmetry between each other:
