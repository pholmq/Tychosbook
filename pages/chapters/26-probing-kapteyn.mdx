...
In any event, it is safe to say that both Kepler's and Newton's 'universally-accepted' theories are by no means flawless; since they can be shown to be mutually contradictory, they cannot therefore be used as 'proof' against the tenets of the Tychos model - or in support of heliocentrism. In the next chapter, we shall take a close look at what may be the gravest and most 'momentous' incongruity of Newtonian physics.  
