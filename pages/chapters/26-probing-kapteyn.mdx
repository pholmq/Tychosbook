...
- Between 9AM and 9PM (i.e. a 12-hour interval), the star quadrants at either side (looking East and West) of Earth show _no_ such dissimmetry in relation to the meridian.
...
Note that 19.2 km (the distance covered by Earth in 12 hours) is 0.1368% of 14036km (the annual distance covered by Earth). Now, Esclangon's observed "dissimmetry" amounted to 0.072 arcseconds - yet, in a subsequent paper* he published in 1928, he appears to have slightly redacted this figure to 0.07 arcseconds.
...
In other words, what Esclangon had observed was the "semi-diurnal dissimmetry" caused by Earth's orbital motion between 3AM and 3PM! In fact, what he had witnessed (to his great puzzlement) is precisely what I expounded in my diagram at the top of this chapter featuring "JOE and JIM".  

As illustrated in my below graphic, what Esclangon (unwittingly) observed - and called a "dissimmetry of space" - was simply due to Earth's 1.6km/h motion, _perpendicular to the star quadrants "A" and "B"_. The other two quadrants ("C" and "D") were not affected since we move at all times either away from quadrant "C" - or towards quadrant "D"; hence, they will not exhibit any dissimmetry between each other:

![](https://septclues.com/TYCHOS/Esclangon_OBSERVATIONS_1927_03.jpg)

Et voilà. What Esclangon observed was a direct consequence of Earth's motion around its PVP orbit. Needless to say, Esclangon had - in his time - no manner of realizing the crucial significance of his observed 'dissimmetry', nor much less to identify its causality. However, Monsieur Ernest Escalgon should now be smiling in Heaven - as his exacting (yet misunderstood) observations have finally found a rational explanation!
