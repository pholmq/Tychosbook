...
In the next chapter, I shall illustrate yet another remarkable aspect of the orbits of Venus and Mercury which definitively proves that they are the moons of the Sun. Namely, that their orbital paths are inclined along the Sun's (hitherto 'mysterious') axial tilt of 6° or 7°. Venus & Mercury are therefore not just the two _the only two bodies_ of our Solar System which have no moons of their own: they are also the only two orbs that revolve around the Sun's equatorial ecliptic!     
