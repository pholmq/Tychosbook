...
Inquiring readers may now wish to compare the above graphic with Figure 16.5 (in Chapter 16). In the latter, we saw that all the ‘inner bodies’ of our system return to the same place in 405500 years, with the sole exception of our Moon which will ‘swap sides’ (at 180°) over this half-Mega Cycle of 811000 years (of 360°). This would conceptually seem to reaffirm our Moon’s role as the ‘central driveshaft’ of the entire system (see Chapter 13).  
