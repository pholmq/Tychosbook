...
Note that there is nothing elliptical about the lunar motions of Venus and Mercury. They both revolve  around the Sun in uniformly circular paths (and at constant speeds), even though their orbital axes are ‘eccentric’ to some degree (meaning that they are off-center in relation to their host - the Sun). 
...
The astute readers will now ask themselves: “HOW can we possibly estimate the true orbital speeds of Venus, Mercury or Mars if they all move around Earth in ‘spirographic’ (or trochoidal) paths – as opposed to concentric rings?” That’s an excellent question; Copernican astronomers have obviously calculated their respective orbital speeds upon the assumption that they move around space in concentric (or slightly elliptical) rings. This means that they have never accounted for the considerable extra distance (i.e. the ‘retrograde loops’) that these bodies are actually covering during one of their earthly revolutions. It follows that all currently-estimated orbital speeds (of Mercury, Venus, Mars and the outer planets) are significantly underestimated – i.e. slower than they are in actuality. So let’s see if we can make (under the TYCHOS model’s tenets) a better estimate of, for instance, the TRUE orbital speed of Mars.

Mars can complete one full revolution around our celestial sphere (that is, when it skips its retrograde period) in 557.65 days on average (range: 544d-571.3d).

The width of Mars’s orbit is 1.5267 times larger than the Sun’s - (note that 557.65 days equals 365.25 x 1.5267).

Mars’s estimated orbital circumference is 1,435,079,524 km (not including its retrograde “teardrop-loop”).

We see that 557.65 days equals 13,383.6 hours. Hence, the TRUE orbital speed of Mars will be:

1,435,079,524 km / 13,383.6 h = **107,226.7 km/h** (or near-exactly the Sun’s estimated speed of 107,226 km/h.

Ergo: Mars physically travels – in all probability - at the very same speed as the Sun! 

![]( https://septclues.com/TYCHOS/SPEED_of_Sun_and_Mars_01.jpg) 

One could hardly wish for stronger evidence that the Sun and Mars are a (magnetically locked?) pair. 
