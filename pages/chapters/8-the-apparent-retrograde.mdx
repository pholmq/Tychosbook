...
Note that there is nothing elliptical at all about the lunar motions of Venus and Mercury. They both revolve  around the Sun in uniformly circular paths (and at constant speeds), even though their orbital axes are ‘eccentric’ to some degree (meaning that they are off-center in relation to their host - the Sun). 
