...
In this other conceptual graphic, I show how the Sun would 'visually' employ ca. 44 days to cover the distance between Polaris and Vega **(_as viewed under an imaginary circumpolar orbit of the Sun_)**. I do realize that my conceptual graphics can be somewhat challenging to take in - but they are the best I can do!  
