...
Perusing conventional online planetariums (such as "Stellarium"), we can see that the Sun (as it moves around our 360° celestial sphere) covers a distance subtending 2h56min of RA (Right Ascension) in 44 days (or 1056 hours). In this other diagram, I show how the Sun would employ ca. 44 days to cover the distance between Polaris and Vega.   
