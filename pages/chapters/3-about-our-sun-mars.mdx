...
- Venus employs **116.88 days** to rotate around its axis - exactly twice as long as Mercury (58.44 X 2 = 116.88). As Venus returns to perigee (closest to Earth) every 584.4 days (i.e. every 10 mercurial rotations), **_it always shows the same face to earthly observers_** - another fact which is still today considered as a 'mystery' by mainstream astronomers! During this period, Venus rotates precisely five times around its own axis (584.4 / 116.88 = 5) - as stated in this Italian "Book of Physics":
