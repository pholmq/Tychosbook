...
### 3.5.1 Rotational resonances between Mercury and Venus
 
• Mercury employs 58.44 days to rotate around its axis [10] and revolves around the Sun in 87.66 days. For every two of its solar revolutions (175.32 days), it thus rotates precisely three times around its axis (175.32 / 58.44 = 3). 

• Venus employs 116.88 days to rotate around its axis—exactly twice as long as Mercury (58.44 x 2 = 116.88). As Venus returns to perigee (closest to Earth) every 584.4 days (i.e., every 10 Mercurial rotations), it always shows the same face to earthly observers—another fact which is still considered a ‘mystery’ by modern astronomers. During this period, Venus rotates five times around its own axis (584.4 / 116.88 = 5), as stated in Isaac Asimov’s “Book of Physics” (quote translated from Italian):
...
Continuing the series of troublesome facts that have been baffling astronomers, here is a quote from Science JRank.org:
...
Let us now compute the respective equatorial rotational speeds of our Moon, Venus and Mercury 

― The Moon rotates around its axis in 27.322 days (or 655.73 hours). The Moon’s circumference is 10920.8 km. Hence, a distance of 10920.8 km covered in 655.73 hours computes to an equatorial rotational speed of **16.65 km/h** - or roughly 100 times slower than the Earth’s equatorial rotational speed of 1674 km/h and 10 times faster than the Earth’s orbital speed of 1.6 km/h.

― Venus rotates around its axis in 116.88 days (or 2805.12 hours). Venus’ circumference is 38024.5 km. Hence, a distance of 38024.5 km covered in 2805.12 hours computes to an equatorial rotational speed of **13.56 km/h**h (or about 18.6% slower than our Moon).

― Mercury rotates around its axis in 58.44 days (or 1402.56 hours). Mercury’s circumference is 15329 km. Hence, a distance of 15329 km covered in 1402.56 hours computes to an equatorial rotational speed of **10.93 km/h** (or about 19.4% slower than Venus). 

These are all, of course, _exceptionally slow_ rotational speeds, compared to those of all the other bodies in our solar system. In fact, they are all in the rotational speed range of a children’s merry-go-round. In contrast, Jupiter rotates around its axis at a brisk 43000 km/h, and Saturn at about 37000 km/h. Such hypersonic speeds are completely unlike the sluggish rotational speeds of moons. Further on (Chapter 20) we shall have a look at Mars’ axial rotational period, which turns out to be synchronous with Earth’s (~24 hours). In any event, the fact that astronomers have never considered Venus and Mercury as lunar satellites―in spite of their glaringly moon-like qualities and behaviours―is a mystery in itself.    


### 3.5.2 Definition of a moon or lunar body
...
→ Moons always (?) show the same face to their host star or planet (in the astronomy jargon, we say they are ‘tidally locked’).
