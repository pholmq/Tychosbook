...
Above: a screenshot from the [Tychosium 3D simulator](https://ts.tychos.space/)
...
We just saw that, according to modern astronomy studies, that all stars are now reckoned to be born in pairs; further on (in Chapter 28), we shall see that a most recent discovery (September 2022) has determined that stars also "die in pairs"! As previously mentioned, the evidence that 100% of the stars may be binary is mounting day by day - yet our Sun is still steadfastly claimed to be a so-called 'single star' or, if you will, a 'lonely bastard'...
...
Let's read a few excerpts from this fascinating article published at Science News on April 4, 2022:
...
Hmm... so two recently-discovered "black holes" turned out to be _"double-star systems at never-before-seen stages in their evolutions"_!... That article is pure dynamite, if you ask me, and is well worth reading in its entirety - but let me submit a few more extracts of it:
...
In conclusion, it would appear that both "dark matter" and "black holes" may be wholly abstract figments of imagination enkindled by our poor understanding of binary systems and their 'optical / astrophysical behavior'.    
