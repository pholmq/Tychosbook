...
## ROTATIONAL RESONANCE OF OUR MOON, MERCURY AND VENUS

A most astonishing realization that the TYCHOS model unveils is that the _rotational_ rates of our Moon, Mercury & Venus (the Sun's two moons) are locked in a seemingly perfect 1:2:4 RESONANCE - a fact that can be empirically tested and verified in the TYCHOSIUM simulator:

- our Moon employs **29.22 days** to rotate around its axis. 

- Mercury employs **58.44 days** to rotate around its axis. [MERCURY](https://books.google.it/books?id=hTvzWMjl_RYC&lpg=PA497&ots=XxA3ZoB8oo&dq=mercury%20rotation%20period%20%2258.44%22&hl=it&pg=PA497#v=onepage&q&f=false)

- Venus employs **116.88 days** to rotate around its axis.

Of course, 29.22 X 2 = 58.44 - and 29.22 X 4 = 116.88. Hence, the three moons are locked in a 1:2:4 rotational resonance.

Needless to say, these are NOT the rotational rates that we can find in official astronomy tables, since the Earth (and our Moon) are believed to revolve around the Sun (and thus, around Mercury and Venus). Therefore, all current reckonings of their rotational speeds are illusory and erroneous. Let us now compute the respective rotational speeds of these three moons:

The Moon rotates around its axis in 29.22 days (or 701.28 hours). The Moon's circumference is 3476.2 km. Hence, a distance of 3476.2 km covered in 701.28 hours computes to a (equatorial) rotational speed of 3476.2 km / 701.28 hours = **4.957 km/h**
...
Venus rotates around its axis in 116.88 days (or 2805.12 hours). Venus’ circumference is 38024.5 km. Hence, a distance of 38024.5 km covered in 14025.6 hours computes to a (equatorial) rotational speed of: 38024.5 km / 2805.12 hours = **13.555 km/h**

These are all, of course, _**exceptionally slow**_ rotational speeds - as compared to all the other bodies ("planets") in our Solar System: they are all in the rotational speed range of a children’s merry-go-round! In any event, these 'snail-paced' speeds are certainly in stark contrast with the formidable velocities that we have all been accustomed to hear about (ever since our school days) in the context of astronomy & cosmology in general.

You may now ask yourselves: _“Are any other celestial bodies in our system reckoned to have such **extremely slow** rotational speeds as our Moon, Mercury or Venus?”_ The answer is no. For instance, Jupiter is said to rotate around its axis at a brisk 43000 km/h and Saturn at about 35000 km/h. These are, of course, hypersonic speeds completely unlike the 'snail-paced' lunar rotational speeds. And what about Mars's axial rotational rate? Well, we shall see about that later, as Mars’s axial rotation turns out to be synchronous with the Earth’s axial rotation (i.e. about 24 hours).
...
In the next chapter, I will illustrate the basic configuration of the TYCHOS model - and introduce you to the interactive TYCHOSIUM 3D simulator; although it may seem somewhat premature to unveil it at this early stage of the book, I believe it is necessary in order for the reader to get a general overview of the TYCHOS before tackling the successive chapters.
