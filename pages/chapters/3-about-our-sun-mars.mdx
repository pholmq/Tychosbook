...
Needless to say, these are NOT the rotational rates that we can find in official astronomy tables, since the Earth (and our Moon) are believed to revolve around the Sun (and thus, around Mercury and Venus). Therefore, all current reckonings of their rotational speeds are erroneous. Let us now compute the respective rotational speeds of these three moons:
...
You may now ask yourselves: _“Are any other celestial bodies in our system reckoned to have such **extremely slow** rotational speeds as our Moon, Mercury or Venus?”_ The answer is no. For instance, Jupiter is said to rotate around its axis at a brisk 43,000 km/h and Saturn at about 35,000 km/h. These are, of course, hypersonic speeds completely unlike the 'snail-paced' lunar rotational speeds. And what about Mars's axial rotational rate? Well, we shall see about that later, as Mars’s axial rotation turns out to be synchronous with the Earth’s axial rotation (i.e. about 24 hours).
