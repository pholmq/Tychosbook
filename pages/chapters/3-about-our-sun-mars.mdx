...
We have all heard of “dark matter” - but what exactly is it meant to be? Apparently, it is some elusive and invisible (i.e. entirely postulated) “stuff” that our modern astrophysicists are desperately attempting to detect in our Universe (yet, so far, with no luck). They currently contend that about 80% of our universe is made of “dark matter” (or “missing matter”) because the observed, highly scattered distributions (and erroneously-estimated orbital speeds) of our universe’s celestial bodies and galaxies appear to violate _both_ Kepler’s and Newton’s hallowed laws (as well as the infamous “Big Bang” theory). Here's an extract from a Wikipedia page titled “Galaxy rotation curve” (my bolds):
