...
In the next chapter, I will illustrate the basic configuration of the TYCHOS model - and introduce you to the wondrous TYCHOSIUM 3D simulator; although it may seem somewhat premature to unveil it at this early stage, I think it is necessary in order for the reader to get a general overview of the TYCHOS before tackling the successive chapters.
