...
- Mercury employs **58.44 days** to rotate around its axis, i.e. exactly twice as long as our Moon. [MERCURY](https://books.google.it/books?id=hTvzWMjl_RYC&lpg=PA497&ots=XxA3ZoB8oo&dq=mercury%20rotation%20period%20%2258.44%22&hl=it&pg=PA497#v=onepage&q&f=false)
It revolves around the Sun in 87.66 days. Every two of its solar revolutions (175.32 days), Mercury rotates three times around its axis (175.32 / 58.44 = 3). In the same period, our Moon will rotate six times around its axis (175.32 / 29.22 = 6).

- Venus employs **116.88 days** to rotate around its axis, i.e. exactly four times as long as our Moon. Venus returns to perigee (closest to Earth) - _always showing the same face to earthly observers_ - every 584.4 days (i.e. every 10 mercurial rotations / or every 20 lunar revolutions). During this period, Venus rotates five times around its own axis (584.4 / 116.88 = 5).
