...
Could it be then that 405500 years is the time employed by the double-double binary system (composed of Sun-Mars & Sirius A-B) to revolve around each other? It would be tempting to submit this hypothesis to those geo-and-astrophysicists who study the famed 405-kyr cycle: if the Sirius System and our Solar System revolve around each other in 405500 years, this could possibly go to explain and corroborate their findings. However, let's not get carried away by such speculative inferences - and leave it up for future researchers to consider and verify. Remarkably though, as I tested this 405500-year period in the current (September 2022) version of the Tychosium 3D simulator, I was able to obtain (just by making extremely small speed adjustments to Venus and Mercury which, in fact, actually _perfected_ the accuracy of their secular, past & future ephemerides) an almost exact realignment of the Sun, Mars, Venus and Mercury... over a 405500-year timespan! 

![](https://septclues.com/TYCHOS/405500years_in_the_TYCHOSIUM.jpg)

I suppose none of us live long enough to verify whether or not Mars, Venus and Mercury will actually return on June 21, 407500 AD in the same celestial positions / ephemerides recorded on June 21, 2000 AD - as predicted by the Tychosium simulator... Yet, if they should, we may only hope that this book (in whatever form or shape) survives until that date - and that our future generations will throw a big party to celebrate the efforts deployed in its making. I, for one, will be popping a bottle of bubbly up in the Heavens and toast with my mother and father.    
