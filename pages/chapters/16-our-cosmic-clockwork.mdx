...
None of us will probably live long enough to verify whether or not Mars, Venus and Mercury will actually return (on June 21, 407500 AD) in the same celestial positions / ephemerides as they were observed (on June 21, 2000 AD) - as predicted by the Tychosium simulator... Yet, if they should, we may only hope that this book (in whatever form or shape) survives until that date - and that our future generations will throw a big party to celebrate the efforts deployed in its making.    
