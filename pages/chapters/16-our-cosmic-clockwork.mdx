...
### THE PECULIAR 405 KYR (KILOYEAR) CYCLE

Astronomers and other scientists who study the Earth's long-term cycles are well familiar with the 405 kyr (kiloyear) cycle. This peculiar period has, for instance, been identified as some sort of 'yardstick' or 'metronome' that regulates the secular, long-term climate cycles.   

> _"The climate cycles are directly related to how the Earth orbits the sun and slight variations in sunlight reaching Earth lead to climate and ecological changes," said Kent, who studies Earth's magnetic field. "The Earth's orbit changes from close to perfectly circular to about 5 percent elongated especially every 405,000 years.(...) The results showed that the 405,000-year cycle is the most regular astronomical pattern linked to the Earth's annual turn around the sun, he said."_ ["Earth's orbital changes have influenced climate"](https://www.sciencedaily.com/releases/2018/05/180507153109.htm)

Interestingly, the 405 kyr cycle is also well-known and hotly debated topic among geologists. Without going into geological considerations (which are beyond the scope of this book), please know that the peculiar time period of **405000 (+/- 500y) years** is being widely used today in geochronology, as it is held to be a particularly steady and significant “geological metronome” of sorts. 
...
Now, please note that if we divide 405500 (i.e. the higher bound of that mean 405kyr value) by 25344, we obtain:

405500y / 25344y ≈ **16**!

In other words, the TGY (the TYCHOS model's proposed 25344-year duration of the Great Year) would seem to be commensurate with very large climate-related and geological timescales! It would therefore be tempting to see if we may find any other relationships in our cosmos - based on this obviously significant 405500-year cycle. If you are game, I suggest that we take another brief look at the Sirius binary system which, as speculated at the end of Chapter 6, may plausibly be the "double-double" binary companion of our binary Solar System:  
...
To wit, this would suggest that our Sun may complete 3.125 X 16 revolutions for every 50-year cycle of the Sirius pair. 
...
Could it be then that 405500 years is the time employed by the double-double binary system (composed of Sun-Mars & Sirius A-B) to revolve around each other? It would be tempting to submit this hypothesis to those geo-and-astrophysicists who study the famed 405-kyr cycle: if the Sirius System and our Solar System revolve around each other in 405500 years, this may be of great significance to their studies. Note for now that 405500 years amounts to 8 X 50688 years (i.e. the Martian "Great Year" - as will be expounded in Chapter 20). Remarkably enough, as I tested this 405500-year period in the current (September 2022) version of the Tychosium 3D simulator, I was able to obtain (after some extremely small speed adjustments to Venus and Mercury which, in fact, actually _perfected_ the accuracy of their secular, past & future ephemerides) an almost exact realignment of the Sun, Mars, Venus and Mercury... over a 405500-year timespan! 

![](https://septclues.com/TYCHOS/405500years_in_the_TYCHOSIUM.jpg)

I suppose that none of us will live long enough to verify whether or not Mars, Venus and Mercury will actually return on June 21, 407500 AD in the same celestial positions / ephemerides recorded on June 21, 2000 AD - as predicted by the Tychosium simulator... Yet, if they should, we can only hope that this book (in whatever form or shape) survives until that date, and that those future generations will throw some big party to celebrate the efforts deployed in its making. I, for one, will be popping a fine bottle of bubbly up in the Heavens and be toasting with my mother and father.    

In the next chapter, we shall keep our feet firmly anchored on Earth - and see if we can resolve the puzzling (and purportedly 'chaotic') behavior of Jupiter and Saturn known to astronomers as "the Great Inequality".     
