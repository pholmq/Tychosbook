...
• As it completes one Exegilmos cycle, our Moon advances by **1/16th** of 1440 minutes of RA (i.e. our celestial sphere).


The question thus becomes: WHY can we find so many indications suggesting a harmoniously resonant and inter-connected Solar System? To be sure, I have no pretense to formulate any 'TOE' (Theory Of Everything) - nor even to explain the 'celestial mechanics' governing our cosmos; yet I do hope that the TYCHOS model might encourage open-minded astrophysicists to consider that electromagnetic (rather than 'gravitational') forces are at play - thus accounting for the wondrous, seemingly holistically-connected 'clockwork' of our system. One thing we know about magnetism is that 'opposed poles' attract each other, whereas two 'identical poles' repel each other. Interestingly, these same phenomena also occur in water vortexes spinning in opposed or identical directions - as demonstrated experimentally in this video to be found on Youtube: ["What is magnetism?" - by Fractal Woman](https://www.youtube.com/watch?v=JGIn45-rw7M)  
...
## THE TYCHOS - AND THE 811000-YEAR MEGA CYCLE

We shall now see how the Tychosium simulator beautifully accounts for the famed 405 kyr cycle (which most people will never have heard of!)...
...
This peculiar time period of **405000 (+/- 500y) years** is a hotly discussed topic within geochronology circles, as it is held to be a particularly accurate and reliable “geologic metronome” of sorts. 
...
As you can see, one may find numerous papers regarding this 'particularly stable' 405000(+/-500)-year cycle all over the scientific literature. Let's now 'arbitrally' use the higher bound of that 405000(+/-500)-year cycle - i.e. 405500 years - and divide it by 25344 (i.e. the Tychos Great Year):

405500y / 25344y ≈ **16** 

Once again, the ubiquitous "16-factor" pops up! Now, here's how the Tychosium 3D simulator depicts an interval of 405500 years (note how Mars, Venus and Mercury return to virtually the same place in our skies - whereas our Moon 'jumps' from one side of the Earth to the other, since the Sun-Moon rotational ratio is 1:12.**5**): 

![](https://septclues.com/TYCHOS/405500years_in_the_TYCHOSIUM.jpg)

In Chapter 6, I conjectured that the Sirius binary system may be our Solar System's "double-double" binary companion. We saw that Sirius A and B revolve around each other in 50 (solar) years.

In 405500 years, Sirius A & B would thus revolve around each other **8110** times (405500 / 50 = 8110).

This is most interesting, because - as shown by the Tychosium simulator, in an interval of **811000** years (i.e. 2X 405500 - or 8110X 100), Mars, Venus and Mercury will again return to the same place in our skies, but this time around, our Moon will ALSO return to virtually the same place! You may verify this for yourself by opening the Tychosium simulator on your laptop - and by following these suggested instructions of mine:

- Set the date of the Tychosium at 1962-02-05 (at 00:00:00 UTC). You will immediately see that February 5, 1962 featured a most spectacular and (extremely rare) multiple planetary conjunction: Mercury, Venus, Jupiter, the Sun and our Moon were all aligned at around 21h15m of RA and, consequently, a solar eclipse was taking place somewhere east of Indonesia, in the Pacific ocean (additionally, Mars and Saturn were conjuncting at around 20h20m of RA). You may then open the Tychosium's "Positions" scroll-down menu and take note of the positions of each of our Solar System's planets and moons.

- Next, change the date to 812962-02-05 (i.e. **811000** years later) and compare the positions of Mercury, Venus, Mars, the Sun and our Moon with those of February 5, 1962. You will see that their ephemerides are virtually identical - and that the Moon will again eclipse the Sun (only a few hours earlier) - somewhere in Indonesia! (As an extra 'bonus', you might also wish to compare the celestial positions of asteroid Eros on the above two dates.) 

In fact, you can perform (in the Tychosium) this 811000-year-interval comparison of the ephemerides of our Sun and Moon + Mercury, Venus & Mars - starting from virtually any date of your choice. Keep in mind that this "mega cycle" of 811000-year period equals 2X 405500 years - and adds up to just about 32 Tychos Great Years (of 25344 solar years). Our Solar System is, you may admit, a most astonishing clockwork - and the TYCHOS model would appear to be the "Antikythera of our modern era"!          

I suppose that none of us will live long enough to verify whether or not Mars, Venus, Mercury the Sun and our Moon will actually return (as predicted by the Tychosium simulator) to the same place every 811000 years... Yet, if they all should do so, we can only hope that this book (in whatever form or shape) survives until that date, and that those distant, future generations will throw a big party to celebrate the efforts deployed in its making. I, for one, will be popping a fine bottle of bubbly up in the Heavens!
