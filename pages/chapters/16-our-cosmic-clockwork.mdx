...
My mind then wandered back to this book's Chapter 6 where I conjectured that the Sirius binary system may be our Solar System's "double-double" binary companion. We saw that Sirius A and B revolve around each other in 50 (solar) years.

In 405500 years, Sirius A & B would thus revolve around each other **8110** times (405500 / 50 = 8110).

This is rather interesting, because - as shown by the Tychosium simulator, in an interval of **811000** years (i.e. 2 X 405500 - or 8110 X 100), Mars, Venus and Mercury will again return to the same place in our skies, but this time around, our Moon will ALSO return to virtually the same place! You may verify this remarkable 811000-year interval for yourself by opening the Tychosium simulator on your laptop - and proceed as follows:
