...
The so-called "405 kyr"(kiloyear) cycle is well known by those scientists who study the Earth's secular cycles - be they astronomers, geologists or dendochronologists. It is today widely considered as a most significant 'yardstick' of sorts which appears to regulate a number of distinct, long-term patterns in various fields of research.   
...
In 405500 years, Sirius A & B would thus revolve around each other **8100** times (405500 / 50 = 8110).

This is most interesting, because - as shown by the Tychosium simulator, in **811000** years (i.e. 2X 405500), Mars, Venus and Mercury will again return to the same place in our skies, but this time around, our Moon will ALSO return to virtually the same place!    

I suppose that none of us will live long enough to verify whether or not Mars, Venus and Mercury and our Moon will actually return (as predicted by the Tychosium simulator) on June 21, 813000 AD in virtually the same celestial positions / ephemerides as they were observed on June 21, 2000 AD... Yet, if they should do so, we can only hope that this book (in whatever form or shape) survives until that date, and that those future generations will throw some big party to celebrate the efforts deployed in its making. I, for one, will be popping a fine bottle of bubbly up in the Heavens!
