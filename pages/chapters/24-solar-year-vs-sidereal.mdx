...
Converting km/s to km/h, we have 0.000224844 x 3600 = **0.809439 km/h.** (i.e. the _diurnal_ variation of "c" observed in several distinct / unrelated interferometer experiments). Once more, this is very close to my 0.8 km/h MVC (“Mean Variation Coefficient”)

You may now wonder how these various interferometers 'worked' - and how the observations performed with the same were translated into data which, ultimately, were interpreted in terms of orbital velocities. For those interested, here is Pierre Fuerxer's thourough analysis (in French) of the most significant interferometer experiments carried out in the past centuries:
