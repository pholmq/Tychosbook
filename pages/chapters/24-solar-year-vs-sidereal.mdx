...
You may now wonder how these various interferometers 'worked' - and how the observations performed with these apparels were translated into data which, ultimately, were 'translated' into orbital velocities. For those interested, here is Pierre Fuerxer's detailed analysis of the most significant interferometer experiments carried out in the past centuries (unfortunately, I have been unable to find an English version of this paper):
