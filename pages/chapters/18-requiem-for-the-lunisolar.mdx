...
Uranus, Neptune and Pluto can all be shown to appear offset due to Earth’s 1-mph motion. All three of them are currently believed to have orbital periods curiously just a whisker short of an integer number of solar years (much like we just saw with Jupiter and Saturn).
