...
Indeed, any rational thinkers should pause right here and ask themselves this logical and primordial question: "why would the Universal Laws of Gravity govern the orbital paths of asteroids and comets in totally different ways?" I strongly suspect that you won't be able to answer this spiny question (which should cause many sleepless nights to our world's astrophysicists). That is, unless you now proceed to the next chapter which should readily relieve you from your misery. Chapter 30 will be the most long-winded of this book - and necessarily so - but I trust that its crucial importance will be fully appreciated; I dare say that it provides indisputable proof that even comets move along circular (yet trochoidal) trajectories, much like all of our system's bodies. By 'reverse engineering' the secular motions of Halley's comet (as documented throughout the ages), we shall see that only the orbital mechanics proposed by the TYCHOS model can account for the same - unlike any other existing model of our Solar System.  
