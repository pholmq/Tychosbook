...
You are therefore left to wonder whether the FACT that Venus return to the same line of sight (in the TYCHOS model) is just an extraordinary coincidence!...

In the next chapter, we shall take a deeper look into the Sun's two moons: Venus and Mercury.
