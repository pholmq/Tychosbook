...
SCREENSHOTS FROM THE SCOPE SIMULATOR

![](https://septclues.com/TYCHOS/031_Scope_VENUS_in_LEO_816days_comparison_02.jpg)

Copernican astronomers will tell you that the reason why this would occur is that the stars are so immensely distant that these two ostensibly PARALLEL lines of sight (towards Venus and Regulus) are perhaps not QUITE parallel and will thus somehow ultimately converge towards star Regulus. Now, we may debate this question of parallelism (or non-parallelism) until the cows come home - but it would be impossible to prove either way. The empirical fact is that Venus was indeed observed to align with star Regulus on those two dates.

The NEAVE planetarium which simulates realistically what we can actually observe in our skies (from our backyard) confirms that Venus and Regulus indeed conjuncted at both ends of our chosen example of an 816-day period (2018-07-10 --> 2020-10-03):

SCREENSHOTS FROM THE NEAVE SIMULATOR
...
Once again, the TYCHOSIUM 3D simulator can demonstrate just how and why Venus _will indeed physically return facing a given star in 816 days_:
...
As you can see, in the TYCHOS model Venus will _actually_ return to the same line of sight between Earth and star Regulus in 816 days (as accurately shown by the Tychosium 3D simulator). Again, the reader is the judge as to which model makes more sense: 

- **The Copernican model** has Venus returning facing the same star after 816 days even though, during this time period, Earth & Venus would have moved 'sideways' by 200Mkm) 

- **The TYCHOS model** has Venus naturally reconjuncting with that same star - simply because it physically returns to that very same celestial longitude!

You are therefore left to wonder whether the FACT that Venus returns to the exact same line of sight (in the TYCHOS model) is just some sort of extraordinary "geometric coincidence"! I sincerely wish you good luck - if you should ever try and put forth such an argumentation in some "Scientific Court of Law"...

In the next chapter, we shall take a deeper look into the Sun's two moons: Venus and Mercury. _"The Sun's two moons?..."_ Yes. As we shall see, Venus and Mercury are the Sun's two lunar satellites - without a shadow of doubt.
