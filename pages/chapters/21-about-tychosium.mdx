...
**(*)NOTE: In any event, this Keplerian theory is directly contradicted by the fact that the Sun's motion (or rather 'Earth's motion' under the heliocentric paradigm) appears to _accelerate_ in June & July, i.e. when Earth's velocity, according to Copernican theory, would be at its MINIMUM - and Earth is at its furthest distance from the Sun.**
