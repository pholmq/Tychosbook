...
The fact that Earth is tilted in such manner may possibly also go to explain why the Sun is further from Earth in the summer (of the Northern Hemisphere) and closer to Earth in the winter (the difference is 152.1Mkm - 147.1Mkm = **5Mkm**): if we consider Earth as a ‘repelling’ magnet (which, so-to-speak, “keeps the Sun from falling into it”), it would make sense that this repulsion peaks around the NH summer solstice – when our ‘heavier’ Northern Hemisphere is mostly tilted towards the Sun (see below graphic). In the winter - when the ‘lighter’ Southern Hemisphere is mostly tilted towards the Sun - this (magnetic?) repulsion wanes somewhat, allowing the Sun to get a little closer to Earth (by 5Mkm). 

However conjectural this thesis may be, I nonetheless believe it worthwhile to consider - were it only as food for thought and future inquiry:
