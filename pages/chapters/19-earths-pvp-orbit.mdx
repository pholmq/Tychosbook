...
Now, where have we seen that **0.0039457%** value before? Well, we saw it in Chapter 12, where we found that it represents the annual motion of the Sun and Earth around their respective orbits. Hence, the leap year effectively "resets" the Earth-Sun alignment with the stars.     
