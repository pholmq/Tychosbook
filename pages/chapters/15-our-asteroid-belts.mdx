...
“Debris disc” around binary system [Source: "Fomalhaut" - at Wikipedia](https://www.tychos.info/citation/_WIKIP-Feb-2017_Fomalhaut.pdf)
...
— ["Telescopes find evidence for asteroid belt around Vega"](https://www.tychos.info/citation/066C_Telescopes-Asteroid.htm) by Jet Propulsion Laboratory (2013)
...
— ["Where Did Earth’s Water Come From?"](https://www.tychos.info/citation/067A_Earths-Water.htm) by Jesse Emspak (“Live Science”, 2016)
...
— ["Flinging Asteroids into the Habitable Zone"](https://www.tychos.info/citation/067B_Flinging-Asteroids.htm) by Anson Lam (2015)

The above article references: ["Asteroid flux towards circumprimary habitable zones in binary star systems: 1. Statistical overview"](https://www.tychos.info/citation/067D_Water-transport.pdf) by D. Bancelin, E. Pilat-Lohinger, S. Eggl, T.I. Maindl, C. Schäfer, R. Speith, R. Dvorak (2015).
...
1. Comets which enter our solar system rarely, if ever, stray right across (i.e., intersect with) Earth’s orbital plane. Cometary orbits are almost invariably tilted in relation to Earth’s orbital plane and very few, if any, pass right through Earth’s celestial path. That is, most comets (which are all rather tiny objects no larger than a few kilometers) pass either “above” or “below” our planet and are unlikely to leave any significant amount of debris trails precisely along Earth’s (supposed) orbital path around the Sun.
 
2. Even if some comets intersected Earth’s supposed Copernican orbit, it would take no longer than a few seconds or minutes for Earth to pass through their debris trails as it (allegedly) travels at 30 km/s. How then could large meteor showers that last for several days be explained?

3. Comets have vastly different periods (e.g. 76 years for Halley’s comet - or 3.3 years for Comet Encke). Indeed, the famous Perseid meteor shower is believed to be caused by the debris trail left over by the Swift-Tuttle comet which has a period of no less than 133 years!. How then could this possibly explain the **_annual_** recurrence of the major meteor showers and their fairly regular intensity? Is this cometary debris supposed to linger for years, decades or even centuries on end in the same area of the sky?
