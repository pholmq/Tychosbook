...
Well, here's the thing: asteroid belts are naturally to be expected around binary systems - as the debris wakes of the two companions collide and get ejected in all directions - as illustrated by this graphic to be found at the Binary Research Institute’s website:

![](https://www.tychos.info/book_imagery/065_Asteroid_Formation_01.gif)

Watch the animated version of the above graphic here: [tinyurl.com/collidingbinarydebris](tinyurl.com/collidingbinarydebris)
