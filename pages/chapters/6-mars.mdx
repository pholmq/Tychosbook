...
Note that, in 2003, Mars passed almost twice closer to Earth (56.6 Mkm) than it did in 2012 (101 Mkm). Note also that, in 2003, Mars was observed to retrograde against the star background by about 40min of RA - whereas, in 2012, it retrograded by as much as 72min of RA. In other words, Mars exhibited a much smaller parallax (in relation to the star background) in 2003 than it did in 2012. Here's a graphic to illustrate what was empirically observed - and how it would look like in the TYCHOSIUM simulator: 
