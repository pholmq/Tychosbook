...
We just saw that Mars’s “habitual” sidereal period (the Long ESI) lasts for around 707 days (about 23 days less than two solar years of 730.5 days. More precisely, Mars returns facing the same star 22.8 days earlier than the Sun does, in a two-year period). The average synodic period of Mars is 779.2 days; this is the time period needed for Mars to line up again _with the Sun_ as viewed from Earth. We see that this is 48.7 days more than two solar years (730.5 + 48.7 = 779.2). Now, we also see that:
...
![](https://www.tychos.info/book_imagery/020_Basic_Sun_Mars_Earth_orbits.jpg)
