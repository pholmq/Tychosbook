...
Let's now compare Kepler’s old diagram of Mars's motions between 1580 and 1596 (a 16-year period) with the TYCHOSIUM simulator's tracing of that same period. As you can see, it looks like Kepler had at one time really been on to something!

[![](https://septclues.com/TYCHOS%20SLIDESHOW%20NEW/SLIDE_22.jpg)

Presumably, Kepler was simply unable to conceive how and why Mars would possibly trace such odd and peculiar trajectories. When it comes to envisioning the geometric dynamics of two magnetically-bound, mutually-orbiting objects (such as the Sun and Mars), the cognitive power of the human mind meets its limits. Modern motion graphics can help us overcome this mental hurdle and realize that these 'spirographic' orbital motions are nothing but natural geometric manifestations of an object revolving around another revolving object. 
...
As it is, Mars can transit in opposition as close (to Earth) as 56.6 Mkm - and as far (from Earth) as 101 Mkm: 56.6 + 101 = **157.6 Mkm**


### Mars’s retrograde periods

As Mars transits in so-called opposition (i.e. when Mars and the Sun find themselves on opposite sides of Earth), its usual West-to-East motion will appear to reverse direction (i.e. to 'retrograde' East-to-West against the star background) for a number of days. My below graphic shows how the famed astrophotographer Tunc Tezel expertly captured the Mars retrogrades of 2003 and 2012 - and how these two periods are traced in the TYCHOSIUM simulator:     

[![](https://septclues.com/TYCHOS/MARS_Retrogrades_TuncTezel_2003_2012.jpg)

Note that, in 2003, Mars passed almost twice closer to Earth (56.6 Mkm) than it did in 2012 (101 Mkm). Note also that, in 2003, Mars was observed to retrograde against the star background by about 40min of RA - whereas, in 2012, it retrograded by as much as 72min of RA. In other words, Mars exhibited a much smaller parallax (in relation to the star background) in 2003 than it did in 2012. Here's a graphic to illustrate what was empirically observed - and how these two events are traced in the TYCHOSIUM simulator: 

[![](https://septclues.com/TYCHOS/MARS_101Mkm_versus_56MkmTransits.jpg)

Well, this is most interesting because, under the Copernican theory, it should be the other way around! The closer Mars passes to Earth, the larger its parallax Let me demonstrate this with the following graphic with which anyone familiar with real-world optical perspectives should easily relate to. After all, we have all acquired throughout our lifetimes some basic (and undeniable) notions of perspective, have we not?

[![](https://septclues.com/TYCHOS/Parallax_LawOfPerspective_01.jpg)

Remember: the Copernican theory states that Mars appears to retrograde whenever Earth (on its 'inside lane') overtakes Mars (on its 'outside lane'). If this were the case, the CLOSER Earth would be to Mars during such an overtaking maneuver, the LARGER the retrograde effect would be. Instead, the exact opposite is empirically observed. Hence, the proposed Copernican explanation for the observed retrograde motions of Mars is invalid and broken - since it violates the most basic laws of spatial / optical perspective.

As we shall see, Mars’s retrograde periods are not by any means the biggest problem with the heliocentric tenets of the Copernican model. There are a number of far graver (and indeed insurmountable) problems with the solar system model we were all taught in school. The next chapter should, in a science-minded world, definitively spell the end of the Copernican era of astronomical belief.
