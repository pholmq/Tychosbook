...
This is most remarkable because, under the Copernican model, it should be precisely the other way around! Let me demonstrate this with my below depiction of a real-world situation with which anyone can easily relate to. Remember: the Copernican theory contends that Mars appears to retrograde whenever Earth (on its 'inside lane') overtakes Mars (on its 'outside lane') and that it is just a matter of changing perspectives - thereby causing a mere _optical illusion_ of Mars back-tracking in the sky against the star backdrop. If this were the case though, the _closer_ Earth would be to Mars during such an overtaking maneuver, the _larger_ the retrograde effect would be. Instead, the exact opposite is empirically observed! Hence, the proposed Copernican theory for the observed retrograde motions of Mars is inadmissible and must be discarded (as an explanation for the retrograde motions of our planets) since it violates this basic law of spatial perspective.
