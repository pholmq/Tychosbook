...
As we consider Earth’s 1.6km/h motion (thus proceeding daily by 38.428km) we see that the distance covered by the Earth-Moon system in the course of a 19756-day Exeligmos cycle turns out to be very close to the **orbital diameter** of our Moon (ca. 763000 km).

19756 days X 38.428 km ≈ 759183.568 km

This is only about 3777 km less than the Moon’s orbital diameter. However, one may reasonably assume that this discrepancy may be accounted for by the diameter of the Moon itself (3476 km). In short, it would seem intuitively logical that an Exeligmos cycle will be completed _when Earth and the Moon have together covered a distance almost equal to the Moon’s orbital diameter:_

Let's see how this 54-year period would look like in the TYCHOS model. As ever, an image speaks more than a thousand words:
...
355 724 597 km / 759223 km ≈ 468.5

If we now multiply this number by 54.1 (468.5 X 54.1) we obtain 25345.85 years, or almost precisely 25344 years - i.e. the duration of the Great Year as computed in the TYCHOS. Hence, the Exeligmos cycle turns out to be in perfect concordance with the Earth-Moon system's joint orbital speed of ≈1.6km/h. The odds of all this being entirely coincidental are, you may admit, 'astronomical'!
...
Now, there's an even more interesting aspect of the Callippic cycle, namely, the officially-computed error rate of the same. Before proceeding, please keep in mind that - more often than not - modern-day astronomers use geocentric coordinates when computing long-term / secular motions of our Solar System's bodies. This is why such official calculations can still be of great interest to the Tychos model.  

So let's see what we can read on Wikipedia – regarding the “error rate” of the Callippic cycle:
...
We see that 553 years X 365.25 = 194678.25 days (_Note that Callippus used a year-count of 365.25 days_)

1 day out of 194678.25 days = 0.000513668 % (we may call this the “Callippic error rate”)

In a Great Year of 25344 solar years (using a 365.25-day year-count) there are 9 256 896 days. So let's see what this “Callippic error rate” would amount to - over a period of 9 256 896 days:

9 256 896 days / 194678.25 days = 47.549718 days (which, in fact, is 0.000513668% of 9 256 896 days)

In other words, the (officially-computed) “Callippic error rate” would also appear to support the correctness of the TYCHOS model's proposed 25344-year duration of the Great Year (rather than the official, modern estimate of 25771 years).
...
In other words, the Moon’s empirically-observed perigeal precession is in full agreement with the TYCHOS-computed duration of a "Great Year" (25344 solar years).
