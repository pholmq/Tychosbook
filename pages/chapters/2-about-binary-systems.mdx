...
- 3. Optical doubles are unrelated stars that only _appear_ close together through chance alignment with Earth.

NOTE: the latter category (3) won't concern us here, since they are nothing but unrelated stars (a closer one and a much more distant one) which just happen to be aligned with our earthly line of sight.
