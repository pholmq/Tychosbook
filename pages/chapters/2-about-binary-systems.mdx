...
Source: [List_of_nearest_stars - Wikipedia](https://simple.wikipedia.org/wiki/List_of_nearest_stars)
...
ESO imagery of binary star HIC 59206 imaged without and with adaptive optics correction. Note distinct binary appearance with adaptive optics. — ESO (May 13, 2003). For more information about ["Adaptive Optics" - Wikipedia](https://www.tychos.info/citation/_WIKIP-Feb-2017_Adaptive_optics.pdf).
