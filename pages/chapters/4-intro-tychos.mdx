...
A comprehensive users’ manual will be implemented in future upgrades of the Tychosium simulator. Meanwhile, here are some basic instructions and tips to get started:

- 1. Click the "play" button > to start the TYCHOSIUM. You may then choose to speed up or slow down its motion with the "1 sec/step equals" function. 
...
- 3. Click on the “Trace settings” menu and choose any solar system body whose path you wish to be traced. This will show you the beautiful mandala-like, spirographic trajectories of our solar system’s various bodies, such as the charming 5-petalled flower pattern traced by Venus. You will then have to check the "Trace On/Off" box.
 
- 4. To see the orientation of our zodiac's 12 constellations, click on the "Stars & Helpers" menu and check the 'Zodiac' box.

- 5. To see the celestial positions (ephemerides) of any of our solar system’s bodies, check the “Show positions” box in the "Controls" menu. You may also hover with your mouse over any celestial body to see their respective ephemeris data at any given time.

- 6. By default, some of the bodies included in the simulator (e.g. Halley's comet and asteroid Eros) are inactive. You can activate them in the "Planets & Orbits" menu.  

- 7. Currently, a dozen stars or so are included in the simulator. Their distances are all set by default to 200AU (in order to be readily visible as you open the Tychosium). You may however toggle their distances in the "Stars & Helpers" menu.
