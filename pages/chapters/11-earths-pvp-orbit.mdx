...
**Fig. 11.3** The diameter of the north star ring’ subtends about 44° of our celestial sphere and the Sun moves by about 44° in 44 days (covering ca. 113 Mkm. Hence, we can draw an imaginary solar polar orbit, a 44° segment of which will represent the diameter of Earth’s PVP orbit.
...
As we saw in Chapter 5, Mars can transit as close as 0.373 Mkm from Earth (as it did in 2003). However, as shown in Table 11.1, the mean figure of its closest passages is about 0.379 AU.
