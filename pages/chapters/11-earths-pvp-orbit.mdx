...
1/3rd of 2112 years------or------1/6th of 4224 years------or------1/36th of 25344 years
...
However, as shown in the below table, the AVERAGE figure of its closest passages is about 0.379AU.
...
> _"**parsec**, unit for expressing distances to stars and galaxies, used by professional astronomers. It represents the distance at which the radius of Earth’s orbit subtends an angle of one second of arc. Thus, a star at a distance of one parsec would have a parallax of one second, and the distance of an object in parsecs is the reciprocal of its parallax in seconds of arc."_ [parsec - Encyclopaedia Britannica](https://www.britannica.com/science/parsec) 
...
- The radius of Earth's PVP orbit is estimated to be 56 615 328 km. 
...
56 615 328 km / 14035.85km  = 4033.62304384 years

In such a period, the stars would appear to ‘precess’ (according to the TYCHOS) by:

4033.62304384y X 51.1**36**(periodic) arcseconds ≈ **206264.81” arcseconds** 

Wow - where did we just see this exact value? That's right: "1 parsec = **206264.81 AU** !"  

Let’s now multiply this value by 2Pi: 206264.81” X 2π = 1 296 000” arcseconds (i.e. a 360° circle: namely, our celestial sphere!) 
...
> _"In astronomy, the sizes of celestial objects are often given in terms of their angular diameter as seen from Earth, rather than their actual sizes. Since these angular diameters are typically small, it is common to present them in arcseconds (″). An arcsecond is 1/3600th of one degree (1°) and a radian is 180/π degrees. So one radian equals 3,600 × 180/π arcseconds, which is about 206,265 arcseconds (1 rad ≈ 206,264.806247"). These objects have an angular diameter of 1″:_
...
And, in fact, wee see that: 206264.81 X 725.27km = 149 597 678.7 km – i.e. near-exactly 1 AU. 

In any event, the fact that the stars would precess by 206264.81" arcseconds in a hypothetical scenario in which Earth were to travel the length of the radius of its PVP orbit (as proposed by the TYCHOS model) would certainly seem to merit further study. Unless, of course, you are inclined to dismiss it all as pure coincidence.       
...
*********************************************************************************************************************
In the next chapter, we shall see how the TYCHOS elegantly accounts for our solar vs sidereal days & years - and why the same cannot be said for the Copernican explanations for these fundamental solar periods.
