...
### December 8, 2023: The 2nd Edition of "The TYCHOS - OUR GEOAXIAL BINARY SYSTEM" is now available in elegant (encrypted) PDF format, for those who prefer to read it on their portable devices. To purchase it, just click on the donate button at the bottom of this page and enter an amount of $25 (or more). Within a day (or less) I will be sending you the PDF and its password via e-mail. For all enquiries you may have, feel free to contact me at my personal e-mail address: simonshack@libero.it    

IMPORTANT NOTE: the PDF contains the final, substantially revised, proofread and graphically refined version of the book (December 1, 2023). On the other hand, the freely accessible chapters on this website are only preliminary drafts of the same and are therefore not to be used for reference purposes. 
