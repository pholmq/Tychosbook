...
- Details for the Stockholm event: [Tap Studio](https://www.tapstudio62.com/simon-shack-och-patrik-holmqvist---the-tychos-och-rymdfusket.html)

- Details for the Malmö event: (forthcoming)

- Details for the Gothenburg event: (forthcoming)
