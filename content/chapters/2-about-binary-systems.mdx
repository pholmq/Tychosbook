...
**Fig. 2.1** A 'classic' binary star system. (Image source: [The SAO Encyclopedia of Astronomy](https://astronomy.swin.edu.au/cosmos/b/binary+star))
...
**Fig. 2.2** Image source: [William Herschel's double star discoveries](http://www.handprint.com/ASTRO/IMG/WHdisc.gif) 
...
> _“In fact, 85% of the stars in the Milky Way galaxy are not single stars, like the Sun, but multiple star systems, binaries or triplets.”_ Source: ["Binary Stars" by Jim Schombert - for University of Oregon (2018)](http://abyss.uoregon.edu/~js/ast122/lectures/lec10.html)

> _"**Are binary stars rare?** No. It is estimated that around 85% of stars exist in binary star systems or systems with three or more stars. Single stars account for around 15% of all stars."_ Source: ["What are binary stars? (Space.com 2023)](https://www.space.com/22509-binary-stars.html)

> _"Binary star systems, containing up to 85% of all stars, have always fascinated scientists due to their various characteristics."_ Source: ["Binary stars: The origins of stellar diversity in binary systems"(2024)](https://www.openaccessgovernment.org/binary-stars-the-origins-of-stellar-diversity-in-binary-systems/176740/)
...
1. Proxima Centauri A / (companions b, c, and d discovered in 2016, 2019 and 2022)
2. Alpha Centauri A / Alpha Centauri B (large companion B discovered long ago)
3. Barnard’s Star A / companions b, c, d, and e discovered in 2024 and 2025)
...
9. Luyten 726-8 A and B (a new companion “C” discovered in 2024)
...
12. Epsilon Eridani A / (companions B and C discovered in 2000 and 2002)
13. Lacaille 9352 (2 or 3 companions discovered in 2020)
...
>_“If the general relativity method is correct, it ought to apply everywhere, not just in the solar system. But Van Flandern points to a conflict outside it: binary stars with highly unequal masses. Their orbits behave in ways that the Einstein formula did not predict. ‘Physicists know about it and shrug their shoulders,’ Van Flandern says. They say there must be ‘something peculiar about these stars, such as an oblateness, or tidal effects.’ Another possibility is that Einstein saw to it that he got the result needed to ‘explain’ Mercury’s orbit, but that it doesn’t apply elsewhere.”_ [Tom Van Flandern articles](http://ldolphin.org/vanFlandern/)
