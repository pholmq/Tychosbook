...
**Fig. 22.4** Excerpt from “The Aberration of Starlight”, by David P. Stern (2006). 
...
James Bradley’s other major claim to fame was what he called the ‘nutation’ of the Earth’s axis, described as _“an annual change of declination in some of the fixed stars that could not be explained by aberration alone”_. It is said to be due to gravitational nudges from the Moon and Sun causing the oblate (non-spherical) Earth to wobble. The Wikipedia entry for ‘Astronomical Nutation’ tells us Bradley reached this conclusion after a _“20-year  series of observations, in which he discovered that the celestial pole moved in a slightly flattened ellipse of 18 by 16 arcseconds about its mean position”._

![](https://septclues.com/TYCHOS/NUTATION_EarthMotion_Bradley_01.jpg) **Fig. 22.6**

Fig. 22.6 shows how the TYCHOS can readily account for Bradley’s imagined ‘nutation’, with no need for any wobble of the Earth’s polar axis: the red ellipse illustrates the length (14036 km) and width (12756 km) of the elliptical ‘zone’ around which an earthly observer gyrates annually. The ratio of this ellipse is ~1.1:1 (14036 / 12756 = 1.1), which is another way of saying that its major axis and minor axis differ by 9.5%. As of the Wikipedia, Bradley’s flattened ellipse was 18" by 16", but other sources have the major axis at 17.6". An ellipse of 17.6" by 16" does in fact have a 1.1:1 ratio (17.6 / 16 = 1.1), equivalent to a 9.5% difference between the axes. Hence,  Bradley’s observed ‘nutation’ was in all likelihood an optical illusion, not an axial wobble. Nonetheless, we must thank Sir Bradley for unwittingly providing further corroboration of the Earth's motion as defined by the TYCHOS model (Chapter 21). 
